...
**Administrative Co-Chairs: [Clemens Gubsch](mailto:clemens.gubsch@oeaw.ac.at) and [Dennis Ried](mailto:dennis.ried@musikwiss.uni-halle.de)**.<br/>
...
The aim of the Music Analysis Interest Group is to provide a forum for discussing the use of MEI encodings for computer-assisted music analysis, including annotation formats and application development. Anyone with an interest in music theory and analysis is welcome to join the group, participate in discussions, ask questions, and share experiences. The group also considers proposals for additions and extensions to the MEI schema that provide support to analytical projects. The IG welcomes any member of the MEI community interested in music analysis to get involved by subscribing to the mailing list [https://lists.uni-paderborn.de/mailman/listinfo/mei-analysis-ig](https://lists.uni-paderborn.de/mailman/listinfo/mei-analysis-ig) or the [MEI Slack channel](https://music-encoding.slack.com/archives/C014F0QAS59) ([join the MEI Slack here](https://join.slack.com/t/music-encoding/shared_invite/zt-4zgx6zbq-2jEjDiUT7ym3dygTaY8C0g)).
