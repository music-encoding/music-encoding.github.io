            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.SLURDIRECTION">data.SLURDIRECTION</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.SLURDIRECTION</span> Slur direction.
                           </td>
...
data.SLURDIRECTION = "up" | "down"</pre></td>
