            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.MEASUREMENT">data.MEASUREMENT</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.MEASUREMENT</span> Measurement expressed in
                              real-world (e.g., centimeters, millimeters, inches, points, or picas) or virtual
                              units (vu). 'vu' is the default value.
                           </td>
...
data.MEASUREMENT = token { pattern = "(\+|-)?\d+(\.\d+)?(cm|mm|in|pt|pc|vu)?" }</pre></td>
