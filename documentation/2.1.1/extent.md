                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;extent&gt; </span>Used
                              to express size in terms other than physical dimensions, such as number of pages,
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.biblPart">model.biblPart</a>
                                 <a class="link_odd_classSpec" href="/documentation/2.1.1/model.physDescPart">model.physDescPart</a>
                              ...
                              <div class="parent">
                                 <div class="specChildren">
                                    ...
                                    <div class="specChild"><span class="specChildModule">MEI.header: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/fileDesc">fileDesc</a>
                                          <a class="link_odd_elementSpec" href="/documentation/2.1.1/physDesc">physDesc</a></span></div>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">extent</span>
{
   ...
   ( text | <a class="link_odd" href="/documentation/2.1.1/model.textphraseLike.limited">model.textphraseLike.limited</a> )*
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>Use the <a class="link_odd_elementSpec" href="/documentation/2.1.1/dimensions">dimensions</a> element when it is necessary to specify the <span style="font-weight:bold">physical</span> size of materials being described, for
