                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;<span class="emptySlash">mensur</span>&gt; </span>(mensuration) – Collects information about the
                              metrical relationship between a note value and the next smaller value; that is,
                              either triple or duple.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              ...
                              <div class="attributeDef"><span class="attribute">@dot</span><span class="attributeClasses"><a class="link_odd" href="/documentation/2.1.1/att.mensur.log">att.mensur.log</a></span></div>
                              ...
                              <div class="attributeDef"><span class="attribute">@form</span><span class="attributeClasses"><a class="link_odd" href="/documentation/2.1.1/att.mensur.vis">att.mensur.vis</a></span></div>
                              ...
                              <div class="attributeDef"><span class="attribute">@orient</span><span class="attributeClasses"><a class="link_odd" href="/documentation/2.1.1/att.mensur.vis">att.mensur.vis</a></span></div>
                              ...
                              <div class="attributeDef"><span class="attribute">@sign</span><span class="attributeClasses"><a class="link_odd" href="/documentation/2.1.1/att.mensur.log">att.mensur.log</a></span></div>
                              <div class="attributeDef"><span class="attribute">@slash</span><span class="attributeClasses"><a class="link_odd" href="/documentation/2.1.1/att.slashcount">att.slashcount</a></span></div>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.eventLike.mensural">model.eventLike.mensural</a>
                                 <a class="link_odd_classSpec" href="/documentation/2.1.1/model.staffDefPart.mensural">model.staffDefPart.mensural</a></div>
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">mensur</span>
{
   ...
   <a class="link_odd" href="/documentation/2.1.1/att.mensur.log">att.mensur.log.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.mensur.vis">att.mensur.vis.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.mensur.ges">att.mensur.ges.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.mensur.anl">att.mensur.anl.attributes</a>,
   empty
}</pre></td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>The <a class="link_odd_elementSpec" href="/documentation/2.1.1/mensur">mensur</a>
                                 element is provided for the encoding of mensural notation. The <span class="att">slash</span> attribute indicates the number lines added to the mensuration
                                 sign. For example, one slash is added for what we now call 'alla breve'.
                              </p>
                           </td>
