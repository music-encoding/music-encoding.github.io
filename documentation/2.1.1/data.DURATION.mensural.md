            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.DURATION.mensural">data.DURATION.mensural</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.DURATION.mensural</span> Logical, that is,
                              written, duration attribute values for the mensural repertoire.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_macroSpec" href="/documentation/2.1.1/data.DURATION">data.DURATION</a>
                                 <a class="link_odd_macroSpec" href="/documentation/2.1.1/data.DURATION.gestural">data.DURATION.gestural</a></div>
                           </td>
