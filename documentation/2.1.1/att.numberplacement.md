            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.numberplacement">att.numberplacement</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.numberplacement</span> Attributes that record the placement and visibility of
                              numbers that accompany a bowed tremolo or tuplet.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.bTrem.vis">att.bTrem.vis</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/bTrem">bTrem</a>] </span>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">num.place</td>
                                    
                                    <td class="odd_value">states where the tuplet number will be placed in relation
                                       to the note heads.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">num.visible</td>
                                    
                                    <td class="odd_value">determines if the tuplet number is visible.
                                       <table class="attDef">
