                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;score&gt; </span>Full
                              score view of the musical content.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.scoreLike">model.scoreLike</a></div>
                           </td>
                              ...
                              <div class="parent">
                                 <div class="specChildren">
                                    <div class="specChild"><span class="specChildModule">MEI.shared: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/incip">incip</a>
                                          <a class="link_odd_elementSpec" href="/documentation/2.1.1/mdiv">mdiv</a></span></div>
                                 </div>
                              </div>
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">score</span>
{
   ...
   <a class="link_odd" href="/documentation/2.1.1/att.score.log">att.score.log.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.score.vis">att.score.vis.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.score.ges">att.score.ges.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.score.anl">att.score.anl.attributes</a>,
   (
    ...
    | <a class="link_odd" href="/documentation/2.1.1/model.scorePart">model.scorePart</a>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>Since the <a class="link_odd_elementSpec" href="/documentation/2.1.1/measure">measure</a>
                                 element is optional, a score may consist entirely of pagebreaks, each of which
                                 points to a page image. <a class="link_odd_elementSpec" href="/documentation/2.1.1/div">div</a> elements are allowed
