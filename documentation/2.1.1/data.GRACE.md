            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.GRACE">data.GRACE</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.GRACE</span> Do grace notes get time from the
                              current (acc) or previous (unacc) one?.
                           </td>
...
data.GRACE = "acc" | "unacc" | "unknown"</pre></td>
