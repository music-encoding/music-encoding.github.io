            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.scoreDef.vis.mensural">att.scoreDef.vis.mensural</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.scoreDef.vis.mensural</span> Visual domain attributes for scoreDef in the
                              mensural repertoire.
                           </td>
