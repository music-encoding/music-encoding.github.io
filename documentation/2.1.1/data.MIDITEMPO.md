            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.MIDITEMPO">data.MIDITEMPO</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.MIDITEMPO</span> MIDI quarter notes per
                              minute: positive integer in the range 10-1000.
                           </td>
...
data.MIDITEMPO =
   xsd:positiveInteger { minInclusive = "10" maxInclusive = "1000" }</pre></td>
