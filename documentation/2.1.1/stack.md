                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;stack&gt;
                                 </span>(stacked text) – An inline table with a single column.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_value">indicates the delimiter used to mark the portions of text
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">align</td>
                                    
                                    <td class="odd_value">specifies how the stacked text components should be
                                       aligned.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value">
                                                <dl class="valList">
                                                   ...
                                                   <dt class="odd_label">left</dt>
                                                   
                                                   <dd class="odd_value">left justified.</dd>
                                                   
                                                   <dt class="odd_label">right</dt>
                                                   
                                                   <dd class="odd_value">right justified.</dd>
                                                   
                                                   <dt class="odd_label">center</dt>
                                                   
                                                   <dd class="odd_value">centered.</dd>
                                                   
                                                   <dt class="odd_label">rightdigit</dt>
                                                   
                                                   <dd class="odd_value">aligned on right-most digit.</dd>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">stack</span>
{
   ...
   attribute [http://www.tei-c.org/ns/1.0]delim { text }?,
   <span class="rnc_keyword">attribute</span> <span class="rnc_nc">[http://www.tei-c.org/ns/1.0]align</span>
   {
      "left" | "right" | "center" | "rightdigit"
   }?,
