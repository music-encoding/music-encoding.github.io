            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.duration.ratio">att.duration.ratio</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.duration.ratio</span> Attributes that describe duration as a ratio.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.mensur.log">att.mensur.log</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/mensur">mensur</a>
                                 <a class="link_odd_elementSpec" href="/documentation/2.1.1/mensuration">mensuration</a>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.note.ges.mensural">att.note.ges.mensural</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/att.note.ges">att.note.ges</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/note">note</a>]
                                    </span>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.proport.log">att.proport.log</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/proport">proport</a>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.rest.ges.mensural">att.rest.ges.mensural</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/att.rest.ges">att.rest.ges</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/rest">rest</a>]
                                    </span>] </span>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">num</td>
                                    
                                    <td class="odd_value">along with numbase, describes duration as a ratio. num is
                                       the first value in the ratio, while numbase is the second.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">numbase</td>
                                    
                                    <td class="odd_value">along with num, describes duration as a ratio. num is the
                                       first value in the ratio, while numbase is the second.
                                       <table class="attDef">
