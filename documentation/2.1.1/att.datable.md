            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.datable">att.datable</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.datable</span> Attributes common to dates.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_elementSpec" href="/documentation/2.1.1/application">application</a>
                              ...
                              <a class="link_odd_elementSpec" href="/documentation/2.1.1/persName">persName</a></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">enddate</td>
                                    
                                    <td class="odd_value">contains the end point of a date range in standard ISO
                                       form.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.ISODATE">data.ISODATE</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">isodate</td>
                                    
                                    <td class="odd_value">provides the value of a textual date in standard ISO
                                       form.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_value">contains an upper boundary for an uncertain date in
                                       standard ISO form.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_value">contains a lower boundary, in standard ISO form, for an
                                       uncertain date.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">startdate</td>
                                    
                                    <td class="odd_value">contains the starting point of a date range in standard
                                       ISO form.
                                       <table class="attDef">
