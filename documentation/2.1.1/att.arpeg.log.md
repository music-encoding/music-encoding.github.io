            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.arpeg.log">att.arpeg.log</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.arpeg.log</span> Logical
                              domain attributes.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_value">describes the direction in which an arpeggio is to be
                                       performed.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value">
                                                <dl class="valList">
                                                   ...
                                                   <dd class="odd_value">lowest to highest pitch.</dd>
                                                   
                                                   <dt class="odd_label">down</dt>
                                                   
                                                   <dd class="odd_value">highest to lowest pitch.</dd>
                                                   
                                                   <dt class="odd_label">nonarp</dt>
                                                   
                                                   <dd class="odd_value">non-arpeggiated style (usually rendered with a
                                                      preceding bracket instead of a wavy line).
                                                   </dd>
