            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.MIDICHANNEL">data.MIDICHANNEL</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.MIDICHANNEL</span> MIDI channel numbers.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><span lang="en">Element: </span><ul>
                                    ...
                                    <li><a class="link_odd_elementSpec" href="/documentation/2.1.1/chan">chan</a>/@num
                                    </li>
...
data.MIDICHANNEL = xsd:positiveInteger { maxInclusive = "16" }</pre></td>
