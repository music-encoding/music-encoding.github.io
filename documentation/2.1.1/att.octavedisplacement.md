            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.octavedisplacement">att.octavedisplacement</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.octavedisplacement</span> Attributes describing the amount and direction of
                              octave displacement.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.clef.log">att.clef.log</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/clef">clef</a>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.octave.log">att.octave.log</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/octave">octave</a>] </span></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">dis</td>
                                    
                                    <td class="odd_value">records the amount of octave displacement.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">dis.place</td>
                                    
                                    <td class="odd_value">records the direction of octave displacement.
                                       <table class="attDef">
