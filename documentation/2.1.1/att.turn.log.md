            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.turn.log">att.turn.log</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.turn.log</span> Logical
                              domain attributes.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_elementSpec" href="/documentation/2.1.1/turn">turn</a></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">delayed</td>
                                    
                                    <td class="odd_value">When the delayed attribute is set to 'true', the turn
                                       begins on the second half of the beat. See Read, p. 246.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_value">indicates the style of the turn.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value">
                                                <dl class="valList">
                                                   ...
                                                   <dd class="odd_value">inverted turn, e.g., begins on the note below
                                                      the written note.
                                                   </dd>
                                                   
                                                   <dt class="odd_label">norm</dt>
                                                   
                                                   <dd class="odd_value">"normal" turn, e.g., begins on the note above
                                                      the written note.
                                                   </dd>
