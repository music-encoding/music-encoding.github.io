                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;incip&gt;
                                 </span>(incipit) – The opening music and/or words of a composition.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.incipLike">model.incipLike</a></div>
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="specChildren">
                                 <div class="specChild"><span class="specChildModule">MEI.figtable: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/graphic">graphic</a></span></div>
                                 <div class="specChild"><span class="specChildModule">MEI.header: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/incipCode">incipCode</a>
                                       ...
                                       <a class="link_odd_elementSpec" href="/documentation/2.1.1/meter">meter</a></span></div>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">incip</span>
{
   ...
   <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/tempo">tempo</a>?,
   <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/role">role</a>?,
   ( <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/clef">clef</a> | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/clefGrp">clefGrp</a> )?,
   ( <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/instrVoice">instrVoice</a> | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/instrVoiceGrp">instrVoiceGrp</a> )?,
   <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/key">key</a>?,
   <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/meter">meter</a>?,
   <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/mensuration">mensuration</a>?,
   ( <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/incipCode">incipCode</a> | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/incipText">incipText</a> | <a class="link_odd" href="/documentation/2.1.1/model.scoreLike">model.scoreLike</a> | <a class="link_odd" href="/documentation/2.1.1/model.graphicLike">model.graphicLike</a> | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/annot">annot</a> )*
}</pre></td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>The <a class="link_odd_elementSpec" href="/documentation/2.1.1/incipText">incipText</a>
                                 element may be used to capture a text incipit, while <a class="link_odd_elementSpec" href="/documentation/2.1.1/score">score</a> is available to provide an MEI-encoded musical incipit.
                                 Images of an incipit may be referenced using the <a class="link_odd_elementSpec" href="/documentation/2.1.1/graphic">graphic</a> element. An incipit encoded in a text format other than
                                 MEI may be placed in the <a class="link_odd_elementSpec" href="/documentation/2.1.1/incipCode">incipCode</a>
                                 element.
                              </p>
                           </td>
