            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.meterSigDefault.vis">att.meterSigDefault.vis</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.meterSigDefault.vis</span> Used by staffDef and scoreDef to provide default
                              values for attributes in the visual domain related to meter signature.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.scoreDef.vis">att.scoreDef.vis</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/scoreDef">scoreDef</a>] </span>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">meter.rend</td>
                                    
                                    <td class="odd_value">contains an indication of how the meter signature should
                                       be rendered.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value">
                                                <dl class="valList">
                                                   ...
                                                   <dt class="odd_label">num</dt>
                                                   
                                                   <dd class="odd_value">show only the number of beats.</dd>
                                                   
                                                   <dt class="odd_label">denomsym</dt>
                                                   
                                                   <dd class="odd_value">the lower number in the meter signature is
                                                      replaced by a note symbol.
                                                   </dd>
                                                   
                                                   <dt class="odd_label">norm</dt>
                                                   
                                                   <dd class="odd_value">meter signature rendered using traditional
                                                      numeric values.
                                                   </dd>
                                                   
                                                   <dt class="odd_label">invis</dt>
                                                   
                                                   <dd class="odd_value">meter signature not rendered.</dd>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">meter.showchange</td>
                                    
                                    <td class="odd_value">determines whether a new meter signature should be
                                       displayed when the meter signature changes.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">meter.sym</td>
                                    
                                    <td class="odd_value">indicates the use of a meter symbol instead of a numeric
                                       meter signature, that is, 'C' for common time or 'C' with a slash for cut
                                       time.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.METERSIGN">data.METERSIGN</a></code></td>
