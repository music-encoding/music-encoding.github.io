            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.STEMPOSITION">data.STEMPOSITION</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.STEMPOSITION</span> Position of a note's stem
                              relative to the head of the note.
                           </td>
...
data.STEMPOSITION = "left" | "right" | "center"</pre></td>
