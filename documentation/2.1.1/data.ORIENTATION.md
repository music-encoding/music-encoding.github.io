            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.ORIENTATION">data.ORIENTATION</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.ORIENTATION</span> Rotation or reflection of
                              base symbol values.
                           </td>
...
data.ORIENTATION = token { pattern = "reversed|90CW|90CCW" }</pre></td>
