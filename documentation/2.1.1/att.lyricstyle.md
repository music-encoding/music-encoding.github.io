            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.lyricstyle">att.lyricstyle</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.lyricstyle</span> Attributes that describe default typography of lyrics.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">lyric.align</td>
                                    
                                    <td class="odd_value">describes the alignment of lyric syllables associated with
                                       a note or chord.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">lyric.fam</td>
                                    
                                    <td class="odd_value">sets the font family default value for lyrics.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">lyric.name</td>
                                    
                                    <td class="odd_value">sets the font name default value for lyrics.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">lyric.size</td>
                                    
                                    <td class="odd_value">sets the default font size value for lyrics.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">lyric.style</td>
                                    
                                    <td class="odd_value">sets the default font style value for lyrics.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">lyric.weight</td>
                                    
                                    <td class="odd_value">sets the default font weight value for lyrics.
                                       <table class="attDef">
