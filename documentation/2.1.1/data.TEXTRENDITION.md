            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.TEXTRENDITION">data.TEXTRENDITION</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.TEXTRENDITION</span> Text rendition
                              values.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><span lang="en">Element: </span><ul>
                                    ...
                                    <li><a class="link_odd_elementSpec" href="/documentation/2.1.1/rend">rend</a>/@rend
                                    </li>
...
data.TEXTRENDITION =
   <span class="rnc_keyword">list</span>
   {
      (
       ...
       | "lro"
       | "rlo"
       | <span class="rnc_type">string</span>
         {
            <span class="rnc_param">pattern</span> = "(underline|overline|line-through|strike|letter-spacing|line-height)\(\d+\)"
         }
       | <span class="rnc_type">string</span>
         {
