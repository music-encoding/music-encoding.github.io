            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.typed">att.typed</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.typed</span> Attributes
                              which can be used to classify or sub-classify features.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_value">characterizes the element in some sense, using any
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_value">provide any sub-classification for the element, additional
                                       to that given by its type attribute.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="wovenodd-col2">
                                                <div xml:space="preserve" class="pre"><br /><span data-indentation="1" class="element">&lt;sch:rule <span class="attribute">context</span>="<span class="attributevalue">mei:*[@subtype]</span>"&gt;</span><br /><br /><span data-indentation="2" class="element">&lt;sch:assert <span class="attribute">test</span>="<span class="attributevalue">@type</span>"&gt;</span>An element with a subtype attribute must have a type<br /> attribute.<span data-indentation="2" class="element">&lt;/sch:assert&gt;</span><br /><span data-indentation="1" class="element">&lt;/sch:rule&gt;</span></div>
                                             </td>
