            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.MENSURATIONSIGN">data.MENSURATIONSIGN</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.MENSURATIONSIGN</span> Mensuration attribute
                              values.
                           </td>
...
data.MENSURATIONSIGN = "C" | "O"</pre></td>
