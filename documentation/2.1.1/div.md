                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;div&gt;
                                 </span>(division) – Major structural division of text, such as a preface, chapter or
                              section.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.divLike">model.divLike</a></div>
                           </td>
                              ...
                              <div class="parent">
                                 <div class="specChildren">
                                    ...
                                    <div class="specChild"><span class="specChildModule">MEI.text: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/back">back</a>
                                          ...
                                          <a class="link_odd_elementSpec" href="/documentation/2.1.1/front">front</a></span></div>
                                 </div>
                              </div>
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <div class="specChildren">
                                 ...
                                 <div class="specChild"><span class="specChildModule">MEI.shared: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/biblList">biblList</a>
                                       ...
                                       <a class="link_odd_elementSpec" href="/documentation/2.1.1/pb">pb</a></span></div>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">div</span>
{
   ...
   <a class="link_odd" href="/documentation/2.1.1/model.milestoneLike.text">model.milestoneLike.text</a>*,
   <a class="link_odd" href="/documentation/2.1.1/model.headLike">model.headLike</a>?,
   ( <a class="link_odd" href="/documentation/2.1.1/model.divLike">model.divLike</a> | <a class="link_odd" href="/documentation/2.1.1/model.textcomponentLike">model.textcomponentLike</a> )+,
   <a class="link_odd" href="/documentation/2.1.1/model.milestoneLike.text">model.milestoneLike.text</a>*
}</pre></td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>Often, the <a class="link_odd_elementSpec" href="/documentation/2.1.1/head">head</a>
                                 sub-element identifies the <a class="link_odd_elementSpec" href="/documentation/2.1.1/div">div</a>'s purpose. This
