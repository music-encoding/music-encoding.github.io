            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.xy2">att.xy2</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.xy2</span> Output
                              coordinate attributes. Some elements may need 2 coordinate pairs to record their
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">x2</td>
                                    
                                    <td class="odd_value">encodes the optional 2nd x coordinate.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">y2</td>
                                    
                                    <td class="odd_value">encodes the optional 2nd y coordinate.
                                       <table class="attDef">
