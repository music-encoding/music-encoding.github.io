            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.accidental.performed">att.accidental.performed</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.accidental.performed</span> Attributes for capturing momentary pitch
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.note.ges">att.note.ges</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/note">note</a>] </span>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">accid.ges</td>
                                    
                                    <td class="odd_value">records the performed pitch inflection when it differs
                                       from the written accidental.
                                       <table class="attDef">
