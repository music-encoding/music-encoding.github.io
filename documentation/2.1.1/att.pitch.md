            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.pitch">att.pitch</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.pitch</span> Attributes
                              that record written pitch name.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.keySig.log">att.keySig.log</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/key">key</a>
                                 <a class="link_odd_elementSpec" href="/documentation/2.1.1/keySig">keySig</a>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.pitched">att.pitched</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/att.custos.log">att.custos.log</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/custos">custos</a>] </span>
                                 <a class="link_odd_classSpec" href="/documentation/2.1.1/att.keyAccid.log">att.keyAccid.log</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/keyAccid">keyAccid</a>] </span>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">pname</td>
                                    
                                    <td class="odd_value">contains a written pitch name.
                                       <table class="attDef">
