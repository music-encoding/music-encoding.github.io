            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.BARPLACE">data.BARPLACE</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.BARPLACE</span> Placement of bar lines. The
                              value 'staff' describes the traditional placement of bar lines.
                           </td>
...
data.BARPLACE = "mensur" | "staff" | "takt"</pre></td>
