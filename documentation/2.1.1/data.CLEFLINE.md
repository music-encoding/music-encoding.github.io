            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.CLEFLINE">data.CLEFLINE</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.CLEFLINE</span> Clef line attribute values.
                              The value must be in the range between 1 and the number of lines on the staff. The
...
data.CLEFLINE = xsd:positiveInteger</pre></td>
