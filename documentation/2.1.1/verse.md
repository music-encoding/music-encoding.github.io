                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              ...
                              <div class="attributeDef"><span class="attribute">@refrain</span><span class="attributeClasses"><a class="link_odd" href="/documentation/2.1.1/att.verse.log">att.verse.log</a></span></div>
                              <div class="attributeDef"><span class="attribute">@rhythm</span><span class="attributeClasses"><a class="link_odd" href="/documentation/2.1.1/att.verse.log">att.verse.log</a></span></div>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.verseLike">model.verseLike</a></div>
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div class="specChildren">
                                    ...
                                    <div class="specChild"><span class="specChildModule">MEI.shared: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/note">note</a></span></div>
                                 </div>
                              </div>
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">verse</span>
{
   ...
   <a class="link_odd" href="/documentation/2.1.1/att.verse.log">att.verse.log.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.verse.vis">att.verse.vis.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.verse.ges">att.verse.ges.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.verse.anl">att.verse.anl.attributes</a>,
   ( <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/dir">dir</a> | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/dynam">dynam</a> | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/tempo">tempo</a> | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/space">space</a> )*,
   <a class="link_odd" href="/documentation/2.1.1/model.sylLike">model.sylLike</a>+,
   <a class="link_odd" href="/documentation/2.1.1/model.lbLike">model.lbLike</a>*
}</pre></td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>The <a class="link_odd_elementSpec" href="/documentation/2.1.1/lb">lb</a> element is
                                 allowed here in order to facilitate karaoke applications. The <span class="att">func</span> attribute on <a class="link_odd_elementSpec" href="/documentation/2.1.1/lb">lb</a> may be used to
                                 distinguish true line endings from those of line groups for these
                                 applications.
                              </p>
                           </td>
