            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.horizontalalign">att.horizontalalign</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.horizontalalign</span> Attributes that record horizontal alignment.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.syl.vis">att.syl.vis</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/syl">syl</a>] </span>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">halign</td>
                                    
                                    <td class="odd_value">records horizontal alignment.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value">
                                                <dl class="valList">
                                                   ...
                                                   <dd class="odd_value">left aligned.</dd>
                                                   
                                                   <dt class="odd_label">right</dt>
                                                   
                                                   <dd class="odd_value">right aligned.</dd>
                                                   
                                                   <dt class="odd_label">center</dt>
                                                   
                                                   <dd class="odd_value">centered.</dd>
                                                   
                                                   <dt class="odd_label">justify</dt>
                                                   
                                                   <dd class="odd_value">left and right aligned.</dd>
