            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.intervalharmonic">att.intervalharmonic</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.intervalharmonic</span> Attributes that describe harmonic intervals.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.intervallicdesc">att.intervallicdesc</a><span class="showmembers2">
                                 ...
                                 <a class="link_odd_classSpec" href="/documentation/2.1.1/att.uneume.anl">att.uneume.anl</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/uneume">uneume</a>] </span>] </span>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">inth</td>
                                    
                                    <td class="odd_value">encodes the harmonic interval between this note and other
                                       pitches occurring at the same time.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg"> xsd:NMTOKENS</code></td>
