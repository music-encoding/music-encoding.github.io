            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.ACCIDENTAL.IMPLICIT">data.ACCIDENTAL.IMPLICIT</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.ACCIDENTAL.IMPLICIT</span> Accidental
                              attribute values.
                           </td>
...
data.ACCIDENTAL.IMPLICIT =
   "s" | "f" | "ss" | "ff" | "n" | "su" | "sd" | "fu" | "fd"</pre></td>
