            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.mensural.log">att.mensural.log</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.mensural.log</span> Used
                              by staffDef and scoreDef to provide default values for attributes in the logical
                              domain related to mensuration. The tempus, prolatio, modusmaior, and modusminor
                              attributes (from the att.mensural.shared class) specify the relationship between the
                              four principle levels of note value, i.e., the long, breve, semibreve and minim, in
                              mensural notation. Modusminor describes the long-breve relationship, while tempus
                              ...
                              attributes describe augmentation or diminution of the normal value of the notes in
                              mensural notation.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.scoreDef.log.mensural">att.scoreDef.log.mensural</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/att.scoreDef.log">att.scoreDef.log</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/scoreDef">scoreDef</a>] </span>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.staffDef.log.mensural">att.staffDef.log.mensural</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/att.staffDef.log">att.staffDef.log</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/staffDef">staffDef</a>] </span>] </span></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">mensur.dot</td>
                                    
                                    <td class="odd_value">determines if a dot is to be added to the base
                                       symbol.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">mensur.sign</td>
                                    
                                    <td class="odd_value">the base symbol in the mensuration sign/time signature of
                                       mensural notation.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.MENSURATIONSIGN">data.MENSURATIONSIGN</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">mensur.slash</td>
                                    
                                    <td class="odd_value">indicates the number lines added to the mensuration sign.
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">proport.num</td>
                                    
                                    <td class="odd_value">Together, proport.num and proport.numbase specify a
                                       proportional change as a ratio, e.g., 1:3. Proport.num is for the first value
                                       in the ratio.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">proport.numbase</td>
                                    
                                    <td class="odd_value">Together, proport.num and proport.numbase specify a
                                       proportional change as a ratio, e.g., 1:3. Proport.numbase is for the second
                                       value in the ratio.
                                       <table class="attDef">
