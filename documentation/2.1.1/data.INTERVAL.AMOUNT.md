            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.INTERVAL.AMOUNT">data.INTERVAL.AMOUNT</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.INTERVAL.AMOUNT</span> A token indicating
                              direction of the interval but not its precise value, an indication of diatonic
                              interval quality and size, or a decimal value in half steps. Decimal values are
...
data.INTERVAL.AMOUNT =
   xsd:decimal
 | token { pattern = "u|d|s" }
 | token { pattern = "(\+|\-)?[AdMmP][0-9]+" }</pre></td>
