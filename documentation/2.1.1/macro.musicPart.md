            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="macro.musicPart">macro.musicPart</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">macro.musicPart</span> groups elements that may
                              appear as part of the music element.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_elementSpec" href="/documentation/2.1.1/music">music</a></div>
                           </td>
...
macro.musicPart = <a class="link_odd" href="/documentation/2.1.1/model.frontLike">model.frontLike</a>?, ( <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/body">body</a> | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/group">group</a> )?, <a class="link_odd" href="/documentation/2.1.1/model.backLike">model.backLike</a>?</pre></td>
