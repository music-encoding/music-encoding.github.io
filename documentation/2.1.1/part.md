                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;part&gt; </span>An
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.partLike">model.partLike</a></div>
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div class="specChildren">
                                    <div class="specChild"><span class="specChildModule">MEI.shared: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/parts">parts</a></span></div>
                                 </div>
                              </div>
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">part</span>
{
   ...
   <a class="link_odd" href="/documentation/2.1.1/att.part.log">att.part.log.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.part.vis">att.part.vis.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.part.ges">att.part.ges.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.part.anl">att.part.anl.attributes</a>,
   (
    ...
    | <a class="link_odd" href="/documentation/2.1.1/model.scorePart">model.scorePart</a>
   )*
}</pre></td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p><a class="link_odd_elementSpec" href="/documentation/2.1.1/part">part</a> elements are
                                 not used in MEI to indicate voice leading. <span class="att">next</span>
                                 attributes on event elements should be used for this purpose. <a class="link_odd_elementSpec" href="/documentation/2.1.1/part">part</a> elements are useful for encoding individual parts when
                                 there is no score, such as early music part books, when the music has non-aligning
                                 bar lines, when different layout, such as page turns, are needed for the score and
                                 ...
                                 marked as 'controlling', while non-aligning ones may be marked as
                                 'non-controlling'.
                              </p>
                           </td>
