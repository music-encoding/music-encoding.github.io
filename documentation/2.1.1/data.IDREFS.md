            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.IDREFS">data.IDREFS</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.IDREFS</span> One or more IDREFs.
                           </td>
...
data.IDREFS = list { <a class="link_odd" href="/documentation/2.1.1/data.IDREF">data.IDREF</a>+ }</pre></td>
