            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.ORNAM.cmn">data.ORNAM.cmn</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.ORNAM.cmn</span> CMN ornam attribute values:
                              A = appogiatura (upper neighbor); a = acciaccatura (lower neighbor); b = bebung; I
                              =
                              ascending slide; i = descending slide; k = delayed turn; K = 5-note turn; m =
                              mordent (alternation with lower neighbor); M = inverted mordent (alternation with
                              upper neighbor); N = Nachschlag (upper neighbor); n = Nachschlag (lower neighbor);
                              S
                              = turn; s = inverted turn; t = trill commencing on auxiliary note; T = trill
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_macroSpec" href="/documentation/2.1.1/data.ORNAMS.cmn">data.ORNAMS.cmn</a></div>
                           </td>
...
data.ORNAM.cmn =
   ...
   {
      <span class="rnc_param">pattern</span> = "[A|a|b|I|i|K|k|M|m|N|n|S|s|T|t|O]|(A|a|S|s|K|k)?(T|t|M|m)(I|i|S|s)?"
   }</pre></td>
