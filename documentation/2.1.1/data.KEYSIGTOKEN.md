            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.KEYSIGTOKEN">data.KEYSIGTOKEN</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.KEYSIGTOKEN</span> A token describing the
                              pitch name, inflection, and octave number of an altered pitch in a key
                              signature.
                           </td>
...
data.KEYSIGTOKEN =
   token { pattern = "[a-g][s|f|ss|x|ff|n|nf|ns|su|sd|fu|fd|nu|nd][0-9]" }</pre></td>
