                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;application&gt;
                                 </span>Provides information about an application which has acted upon the current
                              document.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_value">supplies a version number for an application, independent
                                       of its identifier or display name.
                                       <table class="attDef">
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div class="specChildren">
                                    <div class="specChild"><span class="specChildModule">MEI.header: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/appInfo">appInfo</a></span></div>
                                 </div>
                              </div>
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="specChildren">
                                 ...
                                 <div class="specChild"><span class="specChildModule">MEI.shared: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/name">name</a>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">application</span>
{
   ...
   <a class="link_odd" href="/documentation/2.1.1/model.nameLike">model.nameLike</a>+,
   ( <a class="link_odd" href="/documentation/2.1.1/model.locrefLike">model.locrefLike</a>* | <a class="link_odd" href="/documentation/2.1.1/model.pLike">model.pLike</a>* )
}</pre></td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>"Application" in this context is not to be
                                 confused with software which was used to create the MEI file. The latter may be
                                 recorded in the <a class="link_odd_elementSpec" href="/documentation/2.1.1/projectDesc">projectDesc</a> element.
                              </p>
                           </td>
