            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.FRET">data.FRET</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.FRET</span> In a guitar chord diagram, the
                              fret where the finger should be placed. Since guitar chord diagrams are limited to
                              the range of frets that fall under the hand, the value here is also limited. The pos
                              (position) attribute on the chordDef element must be used to indicate at which fret
                              this range begins.
                           </td>
...
data.FRET = xsd:positiveInteger { minInclusive = "1" maxInclusive = "5" }</pre></td>
