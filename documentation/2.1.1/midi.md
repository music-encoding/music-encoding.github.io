                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;midi&gt;
                                 </span>Container for elements that contain information useful when generating MIDI
                              output.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.midiLike">model.midiLike</a></div>
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="specChildren">
                                 <div class="specChild"><span class="specChildModule">MEI.midi: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/cc">cc</a>
                                       ...
                                       <a class="link_odd_elementSpec" href="/documentation/2.1.1/vel">vel</a></span></div>
                              </div>
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">midi</span>
{
   <a class="link_odd" href="/documentation/2.1.1/att.common">att.common.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.midi.log">att.midi.log.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.midi.vis">att.midi.vis.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.midi.ges">att.midi.ges.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.midi.anl">att.midi.anl.attributes</a>,
   (
      <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/cc">cc</a>
    | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/chan">chan</a>
    | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/chanPr">chanPr</a>
    | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/cue">cue</a>
    | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/hex">hex</a>
    | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/marker">marker</a>
    | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/metaText">metaText</a>
    | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/noteOff">noteOff</a>
    | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/noteOn">noteOn</a>
    | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/port">port</a>
    | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/prog">prog</a>
    | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/seqNum">seqNum</a>
    | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/trkName">trkName</a>
    | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/vel">vel</a>
   )*
}</pre></td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>The <span class="att">label</span> attribute can
                                 be used to differentiate between multiple MIDI data streams, e.g.
