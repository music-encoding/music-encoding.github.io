            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.SLUR">data.SLUR</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.SLUR</span> i=initial, m=medial, t=terminal.
                              Number is used to match endpoints of the slur when slurs are nested or overlap, e.g.
                              &lt;note slur='i1 i2'/&gt;&lt;note slur='t1'/&gt;&lt;note slur='t2'/&gt; encodes the
                              fact that two slurs begin on note 1, one which terminates on note 2 and one which
                              terminates on note 3.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_macroSpec" href="/documentation/2.1.1/data.SLURS">data.SLURS</a></div>
                           </td>
...
data.SLUR = token { pattern = "[i|m|t][1-6]" }</pre></td>
