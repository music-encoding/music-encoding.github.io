            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.URIS">data.URIS</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.URIS</span> One or more URIs.
                           </td>
...
data.URIS = list { <a class="link_odd" href="/documentation/2.1.1/data.URI">data.URI</a>* }</pre></td>
