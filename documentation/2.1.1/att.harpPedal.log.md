            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.harpPedal.log">att.harpPedal.log</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.harpPedal.log</span> Logical domain attributes. The pedal setting, i.e., flat,
                              natural, or sharp, for each diatonic pitch name is indicated by the seven
                              letter-named attributes.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_elementSpec" href="/documentation/2.1.1/harpPedal">harpPedal</a></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">c</td>
                                    
                                    <td class="odd_value">indicates the pedal setting for the harp's C
                                       strings.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value">
                                                <dl class="valList">
                                                   ...
                                                   <dd class="odd_value">flat.</dd>
                                                   
                                                   <dt class="odd_label">n</dt>
                                                   
                                                   <dd class="odd_value">natural.<span class="defaultVal" lang="en">
                                                         [Default]</span></dd>
                                                   
                                                   <dt class="odd_label">s</dt>
                                                   
                                                   <dd class="odd_value">sharp.</dd>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">d</td>
                                    
                                    <td class="odd_value">indicates the pedal setting for the harp's D
                                       strings.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">e</td>
                                    
                                    <td class="odd_value">indicates the pedal setting for the harp's E
                                       strings.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">f</td>
                                    
                                    <td class="odd_value">indicates the pedal setting for the harp's F
                                       strings.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">g</td>
                                    
                                    <td class="odd_value">indicates the pedal setting for the harp's G
                                       strings.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">a</td>
                                    
                                    <td class="odd_value">indicates the pedal setting for the harp's A
                                       strings.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">b</td>
                                    
                                    <td class="odd_value">indicates the pedal setting for the harp's B
                                       strings.
                                       <table class="attDef">
