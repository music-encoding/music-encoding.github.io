            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.PITCHCLASS">data.PITCHCLASS</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.PITCHCLASS</span> Pclass (pitch class)
                              attribute values.
                           </td>
...
data.PITCHCLASS = xsd:nonNegativeInteger { maxInclusive = "11" }</pre></td>
