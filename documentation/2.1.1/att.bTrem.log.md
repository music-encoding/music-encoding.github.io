            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.bTrem.log">att.bTrem.log</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.bTrem.log</span> Logical
                              domain attributes.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_value">describes the style of the tremolo.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value">
                                                <dl class="valList">
                                                   ...
                                                   <dt class="odd_label">meas</dt>
                                                   
                                                   <dd class="odd_value">measured tremolo.</dd>
                                                   
                                                   <dt class="odd_label">unmeas</dt>
                                                   
                                                   <dd class="odd_value">unmeasured tremolo.</dd>
