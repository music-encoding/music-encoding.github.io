            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.solfa">att.solfa</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.solfa</span> Attributes
                              that specify pitch using sol-fa.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">psolfa</td>
                                    
                                    <td class="odd_value">contains sol-fa designation, e.g., do, re, mi, etc., in
                                       either a fixed or movable Do system.
                                       <table class="attDef">
