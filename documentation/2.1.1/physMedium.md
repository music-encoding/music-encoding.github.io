                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;physMedium&gt;
                                 </span>(physical medium) – Records the physical materials used in the source, such
                              as ink and paper.
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">physMedium</span>
{
   ...
   ( text | <a class="link_odd" href="/documentation/2.1.1/model.textphraseLike.limited">model.textphraseLike.limited</a> )*
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>All materials may be described in a single <a class="link_odd_elementSpec" href="/documentation/2.1.1/physMedium">physMedium</a> element or multiple elements may be used,
                                 one for each medium.
                              </p>
                           </td>
