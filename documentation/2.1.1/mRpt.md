                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;<span class="emptySlash">mRpt</span>&gt; </span>(measure repeat) – An indication that the previous
                              measure should be repeated.
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">mRpt</span>
{
   ...
   <a class="link_odd" href="/documentation/2.1.1/att.mRpt.log">att.mRpt.log.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.mRpt.vis">att.mRpt.vis.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.mRpt.ges">att.mRpt.ges.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.mRpt.anl">att.mRpt.anl.attributes</a>,
   empty
}</pre></td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              ...
                              <p>The automated numbering of consecutive measures
                                 of rest may be controlled via the <span class="att">multi.number</span> attribute
