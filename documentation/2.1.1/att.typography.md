            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.typography">att.typography</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.typography</span> Typographical attributes.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.lyrics.vis">att.lyrics.vis</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/lyrics">lyrics</a>] </span>
                              ...
                              <a class="link_odd_elementSpec" href="/documentation/2.1.1/rend">rend</a></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">fontfam</td>
                                    
                                    <td class="odd_value">contains the name of a font-family.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">fontname</td>
                                    
                                    <td class="odd_value">holds the name of a font.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">fontsize</td>
                                    
                                    <td class="odd_value">indicates the size of a font in printers' points, i.e.,
                                       1/72nd of an inch.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">fontstyle</td>
                                    
                                    <td class="odd_value">records the style of a font, i.e, italic, oblique, or
                                       normal.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">fontweight</td>
                                    
                                    <td class="odd_value">used to indicate bold type.
                                       <table class="attDef">
