            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.STRINGNUMBER">data.STRINGNUMBER</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.STRINGNUMBER</span> In string tablature, the
                              number of the string to be played, i.e., [1-9]+.
                           </td>
...
data.STRINGNUMBER = xsd:positiveInteger</pre></td>
