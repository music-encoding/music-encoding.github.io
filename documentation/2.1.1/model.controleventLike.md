            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="model.controleventLike">model.controleventLike</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">model.controleventLike</span> groups elements, such as dynamics, ties, phrase
                              marks, pedal marks, etc., which depend upon other events, such as notes or rests,
                              for their existence.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_elementSpec" href="/documentation/2.1.1/abbr">abbr</a>
                                 ...
                                 <a class="link_odd_classSpec" href="/documentation/2.1.1/model.layerPart.mensural">model.layerPart.mensural</a>
                                 <a class="link_odd_classSpec" href="/documentation/2.1.1/model.measurePart">model.measurePart</a>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.controleventLike.cmn">model.controleventLike.cmn</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/model.ornamentLike.cmn">model.ornamentLike.cmn</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/mordent">mordent</a>
                              ...
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/model.controleventLike.harmony">model.controleventLike.harmony</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/model.harmLike">model.harmLike</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/harm">harm</a>]
                                    </span>] </span>
                              ...
                              <a class="link_odd_elementSpec" href="/documentation/2.1.1/tempo">tempo</a></td>
