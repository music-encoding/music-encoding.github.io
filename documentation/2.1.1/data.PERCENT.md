            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.PERCENT">data.PERCENT</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.PERCENT</span> Positive decimal number plus
                              '%', i.e., [0-9]+(\.?[0-9]*)?\%.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_macroSpec" href="/documentation/2.1.1/data.PGSCALE">data.PGSCALE</a></div>
                           </td>
...
data.PERCENT = token { pattern = "[0-9]+(\.?[0-9]*)?%" }</pre></td>
