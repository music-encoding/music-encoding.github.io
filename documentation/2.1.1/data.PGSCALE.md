            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.PGSCALE">data.PGSCALE</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.PGSCALE</span> Page scale factor; a
                              percentage of the values in page.height and page.width.
                           </td>
...
data.PGSCALE = <a class="link_odd" href="/documentation/2.1.1/data.PERCENT">data.PERCENT</a></pre></td>
