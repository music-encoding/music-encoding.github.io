            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.accidental">att.accidental</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.accidental</span> Attributes for capturing momentary pitch inflection.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.accid.log">att.accid.log</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/accid">accid</a>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.keyAccid.log">att.keyAccid.log</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/keyAccid">keyAccid</a>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.keySig.log">att.keySig.log</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/key">key</a>
                                 <a class="link_odd_elementSpec" href="/documentation/2.1.1/keySig">keySig</a>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.note.log">att.note.log</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/note">note</a>]
                                 </span></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">accid</td>
                                    
                                    <td class="odd_value">captures a written accidental.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.ACCIDENTAL.EXPLICIT">data.ACCIDENTAL.EXPLICIT</a></code></td>
