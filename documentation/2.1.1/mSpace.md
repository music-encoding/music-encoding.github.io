                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;<span class="emptySlash">mSpace</span>&gt; </span>(measure space) – A measure containing only empty
                              space in any meter.
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">mSpace</span>
{
   ...
   <a class="link_odd" href="/documentation/2.1.1/att.mSpace.log">att.mSpace.log.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.mSpace.vis">att.mSpace.vis.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.mSpace.ges">att.mSpace.ges.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.mSpace.anl">att.mSpace.anl.attributes</a>,
   empty
}</pre></td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>The automated numbering of consecutive measures
                                 of space may be controlled via the <span class="att">multi.number</span> attribute
                                 on the <a class="link_odd_elementSpec" href="/documentation/2.1.1/scoreDef">scoreDef</a> or <a class="link_odd_elementSpec" href="/documentation/2.1.1/staffDef">staffDef</a> elements.
                              </p>
                           </td>
