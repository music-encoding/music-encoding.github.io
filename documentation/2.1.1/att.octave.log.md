            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.octave.log">att.octave.log</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.octave.log</span> Logical domain attributes.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">coll</td>
                                    
                                    <td class="odd_value">indicates whether the octave displacement should be
                                       performed simultaneously with the written notes, i.e., "coll' ottava". Unlike
                                       other octave signs which are indicated by broken lines, coll' ottava typically
                                       uses an unbroken line or a series of longer broken lines, ending with a short
                                       vertical stroke. See Read, p. 47-48.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value">
                                                <dl class="valList">
                                                   ...
                                                   <dt class="odd_label">coll</dt>
                                                   
                                                   <dd class="odd_value">coll' ottava (with the octave).</dd>
