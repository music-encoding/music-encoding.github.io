            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.OCTAVE.DIS">data.OCTAVE.DIS</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.OCTAVE.DIS</span> The amount of octave
                              displacement; that is, '8' (as in '8va' for 1 octave), '15' (for 2 octaves), or
                              rarely '22' (for 3 octaves).
                           </td>
...
data.OCTAVE.DIS = xsd:positiveInteger { pattern = "8|15|22" }</pre></td>
