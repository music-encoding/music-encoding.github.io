            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="macro.availabilityPart">macro.availabilityPart</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">macro.availabilityPart</span> groups elements that
                              may appear as part of a description of the availability of and access to a
                              bibliographic item.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_elementSpec" href="/documentation/2.1.1/availability">availability</a>
                                 <a class="link_odd_elementSpec" href="/documentation/2.1.1/item">item</a></div>
                           </td>
...
macro.availabilityPart =
   ( <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/acqSource">acqSource</a>, ( <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/accessRestrict">accessRestrict</a>, <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/price">price</a>? )* )*,
   <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/useRestrict">useRestrict</a>?,
   <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/sysReq">sysReq</a>?</pre></td>
