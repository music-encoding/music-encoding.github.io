            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.note.ges">att.note.ges</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.note.ges</span> Gestural
                              domain attributes.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">oct.ges</td>
                                    
                                    <td class="odd_value">records performed octave information that differs from the
                                       written value.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.OCTAVE">data.OCTAVE</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">pname.ges</td>
                                    
                                    <td class="odd_value">contains a performed pitch name that differs from the
                                       written value.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.PITCHNAME.GES">data.PITCHNAME.GES</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">pnum</td>
                                    
                                    <td class="odd_value">holds a pitch-to-number mapping, a base-40 or MIDI note
                                       number, for example.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.PITCHNUMBER">data.PITCHNUMBER</a></code></td>
