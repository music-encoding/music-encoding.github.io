            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.midiinstrument">att.midiinstrument</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.midiinstrument</span> Attributes that record MIDI instrument information.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_elementSpec" href="/documentation/2.1.1/instrDef">instrDef</a></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">midi.instrnum</td>
                                    
                                    <td class="odd_value">sets the MIDI instrument number.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">midi.instrname</td>
                                    
                                    <td class="odd_value">provides a General MIDI label for the MIDI
                                       instrument.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.MIDINAMES">data.MIDINAMES</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">midi.pan</td>
                                    
                                    <td class="odd_value">sets the instrument's position in a stereo field. Values
                                       of 0 and 1 both pan left, 127 pans right, and 64 pans to the center.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">midi.volume</td>
                                    
                                    <td class="odd_value">sets the instrument's volume.
                                       <table class="attDef">
