            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.cleffing.log">att.cleffing.log</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.cleffing.log</span> Used
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">clef.shape</td>
                                    
                                    <td class="odd_value">encodes a value for the clef symbol.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.CLEFSHAPE">data.CLEFSHAPE</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">clef.line</td>
                                    
                                    <td class="odd_value">contains a default value for the position of the clef. The
                                       value must be in the range between 1 and the number of lines on the staff. The
                                       numbering of lines starts with the lowest line of the staff.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.CLEFLINE">data.CLEFLINE</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">clef.dis</td>
                                    
                                    <td class="odd_value">records the amount of octave displacement to be applied to
                                       the clef.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.OCTAVE.DIS">data.OCTAVE.DIS</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">clef.dis.place</td>
                                    
                                    <td class="odd_value">records the direction of octave displacement to be applied
                                       to the clef.
                                       <table class="attDef">
