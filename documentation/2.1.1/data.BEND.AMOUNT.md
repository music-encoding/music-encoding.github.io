            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.BEND.AMOUNT">data.BEND.AMOUNT</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.BEND.AMOUNT</span> Either a decimal value or
                              a token. The decimal values are limited to .25, .5, .75, or 1, while the token
                              values are restricted to 'full'.
                           </td>
...
data.BEND.AMOUNT =
   xsd:decimal { pattern = "1|\.25|\.5|\.75" } | token { pattern = "full" }</pre></td>
