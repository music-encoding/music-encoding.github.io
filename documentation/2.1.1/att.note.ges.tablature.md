            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.note.ges.tablature">att.note.ges.tablature</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.note.ges.tablature</span> Gestural domain attributes.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">tab.fret</td>
                                    
                                    <td class="odd_value">records the fret at which a string should be
                                       stopped.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.FRETNUMBER">data.FRETNUMBER</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">tab.string</td>
                                    
                                    <td class="odd_value">records which string is to be played.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.STRINGNUMBER">data.STRINGNUMBER</a></code></td>
