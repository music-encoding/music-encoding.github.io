                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;termList&gt;
                                 </span>Collection of text phrases which describe a resource.
                           </td>
                              ...
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_value">contains a reference to the controlled vocabulary from
                                       which the terms are drawn. The value must match the value of an ID attribute
                                       on a classCode element given elsewhere in the document.
                                       <table class="attDef">
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">termList</span>
{
   ...
   <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/term">term</a>+
}</pre></td>
