            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.tuplet.vis">att.tuplet.vis</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.tuplet.vis</span> Visual
                              domain attributes.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.tupletSpan.vis">att.tupletSpan.vis</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/tupletSpan">tupletSpan</a>] </span>
                              <a class="link_odd_elementSpec" href="/documentation/2.1.1/tuplet">tuplet</a></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">bracket.place</td>
                                    
                                    <td class="odd_value">used to state where a tuplet bracket will be placed in
                                       relation to the note heads.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.PLACE">data.PLACE</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">bracket.visible</td>
                                    
                                    <td class="odd_value">states whether a bracket should be rendered with a
                                       tuplet.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">dur.visible</td>
                                    
                                    <td class="odd_value">determines if the tuplet duration is visible.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">num.format</td>
                                    
                                    <td class="odd_value">controls how the num:numbase ratio is to be
                                       displayed.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value">
                                                <dl class="valList">
                                                   ...
                                                   <dt class="odd_label">count</dt>
                                                   
                                                   <dd class="odd_value">only the num attribute is displayed, e.g.,
                                                      '7'.
                                                   </dd>
                                                   
                                                   <dt class="odd_label">ratio</dt>
                                                   
                                                   <dd class="odd_value">both the num and numbase attributes are
                                                      displayed, e.g., '7:4'.
                                                   </dd>
