            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.SLASH">data.SLASH</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.SLASH</span> The number of slashes to be
                              rendered for tremolandi.
                           </td>
...
data.SLASH = xsd:positiveInteger { minInclusive = "1" maxInclusive = "6" }</pre></td>
