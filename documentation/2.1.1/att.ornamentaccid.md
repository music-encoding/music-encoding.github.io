            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.ornamentaccid">att.ornamentaccid</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.ornamentaccid</span> Accidentals associated with ornaments.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.mordent.log">att.mordent.log</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/mordent">mordent</a>] </span>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">accidupper</td>
                                    
                                    <td class="odd_value">records the written accidental associated with an upper
                                       neighboring note.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">accidlower</td>
                                    
                                    <td class="odd_value">records the written accidental associated with a lower
                                       neighboring note.
                                       <table class="attDef">
