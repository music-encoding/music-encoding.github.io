            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.channelized">att.channelized</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.channelized</span> Attributes that record MIDI channel information.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.scoreDef.ges">att.scoreDef.ges</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/scoreDef">scoreDef</a>] </span>
                              <a class="link_odd_elementSpec" href="/documentation/2.1.1/instrDef">instrDef</a></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">midi.channel</td>
                                    
                                    <td class="odd_value">records a MIDI channel value.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">midi.duty</td>
                                    
                                    <td class="odd_value">specifies the 'on' part of the duty cycle as a percentage
                                       of a note's duration.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">midi.port</td>
                                    
                                    <td class="odd_value">sets the MIDI port value.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.MIDIVALUE">data.MIDIVALUE</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">midi.track</td>
                                    
                                    <td class="odd_value">sets the MIDI track.
                                       <table class="attDef">
