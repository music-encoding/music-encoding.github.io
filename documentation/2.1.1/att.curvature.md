            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.curvature">att.curvature</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.curvature</span> Attributes that describe curvature.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.bend.vis">att.bend.vis</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/bend">bend</a>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.phrase.vis.cmn">att.phrase.vis.cmn</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/att.phrase.vis">att.phrase.vis</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/phrase">phrase</a>] </span>] </span>
                              ...
                              <a class="link_odd_elementSpec" href="/documentation/2.1.1/curve">curve</a></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">bezier</td>
                                    
                                    <td class="odd_value">records the placement of Bezier control points as a series
                                       of space-separated xy coordinates, e.g., 19 45 -32 118.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">bulge</td>
                                    
                                    <td class="odd_value">describes a curve as a set of distance values above or
                                       below an imaginary line connecting the endpoints of the curve. The bulge
                                       attribute must contain one or more decimal values expressed in inter-line
                                       units.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">curvedir</td>
                                    
                                    <td class="odd_value">describes a curve with a generic term indicating the
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value">
                                                <dl class="valList">
                                                   ...
                                                   <dd class="odd_value">upward curve.</dd>
                                                   
                                                   <dt class="odd_label">below</dt>
                                                   
                                                   <dd class="odd_value">downward curve.</dd>
