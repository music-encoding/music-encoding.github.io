            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.OCTAVE">data.OCTAVE</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.OCTAVE</span> Oct attribute values. The
                              default values conform to Acoustical Society of America representation. Read, p.
                              44.
                           </td>
...
data.OCTAVE = xsd:nonNegativeInteger { maxInclusive = "9" }</pre></td>
