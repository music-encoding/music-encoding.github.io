            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="macro.XSLT">macro.XSLT</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">macro.XSLT</span> permits any element from the
                              XSLT namespace. Allowing XSLT in &lt;incipit&gt; makes it possible to generate the
                              incipit from the notational content of the MEI file.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_macroSpec" href="/documentation/2.1.1/macro.XSLT">macro.XSLT</a></div>
                           </td>
...
macro.XSLT =
   element d38e18169a3528:* { attribute * { text }*, ( text | <a class="link_odd" href="/documentation/2.1.1/macro.XSLT">macro.XSLT</a> )* }</pre></td>
