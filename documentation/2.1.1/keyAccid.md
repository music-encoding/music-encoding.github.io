                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;<span class="emptySlash">keyAccid</span>&gt; </span>(key accidental) – Accidental in a key
                              signature.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_value">specifies whether enharmonic (written) values or implicit
                                       ("perform-able") values are allowed.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value">
                                                <dl class="valList">
                                                   ...
                                                   <dt class="odd_label">implicit</dt>
                                                   
                                                   <dd class="odd_value">only performed values (sharp, flat, natural)
                                                      allowed.
                                                   </dd>
                                                   
                                                   <dt class="odd_label">explicit</dt>
                                                   
                                                   <dd class="odd_value">all enharmonic (written) values allowed.</dd>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.keyAccidLike">model.keyAccidLike</a></div>
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div class="specChildren">
                                    <div class="specChild"><span class="specChildModule">MEI.shared: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/keySig">keySig</a></span></div>
                                 </div>
                              </div>
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">keyAccid</span>
{
   ...
   <a class="link_odd" href="/documentation/2.1.1/att.keyAccid.anl">att.keyAccid.anl.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.keyAccid.ges">att.keyAccid.ges.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.keyAccid.log">att.keyAccid.log.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.keyAccid.vis">att.keyAccid.vis.attributes</a>,
   attribute [http://www.tei-c.org/ns/1.0]form { "implicit" | "explicit" }?,
   empty
}</pre></td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div xml:space="preserve" class="pre"><br /><span data-indentation="1" class="element">&lt;sch:rule <span class="attribute">context</span>="<span class="attributevalue">mei:keyAccid</span>"&gt;</span><br /><br /><span data-indentation="2" class="element">&lt;sch:assert <span class="attribute">test</span>="<span class="attributevalue">(@x and @y) or @loc</span>"&gt;</span>The @x and @y pair of attributes or @loc<br /> required.<span data-indentation="2" class="element">&lt;/sch:assert&gt;</span><br /><span data-indentation="1" class="element">&lt;/sch:rule&gt;</span></div>
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>It is a semantic error not to provide either the
                                 <span class="att">x</span> and <span class="att">y</span> pair of attributes or
                                 the <span class="att">staffloc</span> attribute.
                              </p>
                           </td>
