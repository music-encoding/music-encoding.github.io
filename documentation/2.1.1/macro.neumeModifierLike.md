            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="macro.neumeModifierLike">macro.neumeModifierLike</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">macro.neumeModifierLike</span> groups elements
                              that modify neume-like features.
                           </td>
...
macro.neumeModifierLike = empty</pre></td>
