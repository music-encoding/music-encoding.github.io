                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;ligature&gt; </span>A
                              mensural notation symbol that combines two or more notes into a single sign.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              ...
                              <div class="attributeDef"><span class="attribute">@form</span><span class="attributeClasses"><a class="link_odd" href="/documentation/2.1.1/att.ligature.log">att.ligature.log</a></span></div>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.eventLike.mensural">model.eventLike.mensural</a></div>
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">ligature</span>
{
   ...
   <a class="link_odd" href="/documentation/2.1.1/att.ligature.log">att.ligature.log.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.ligature.vis">att.ligature.vis.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.ligature.ges">att.ligature.ges.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.ligature.anl">att.ligature.anl.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/model.layerPart">model.layerPart</a>*
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>The rhythmic meaning of the components of a
                                 ligature is typically contextual, not absolute; therefore, an interpretative
                                 duration may be encoded on each of the components using either the <span class="att">dur.ges</span> attribute or the <span class="att">num</span> and
                                 <span class="att">numbase</span> attribute pair. The <a class="link_odd_elementSpec" href="/documentation/2.1.1/ligature">ligature</a> element should <span style="font-weight:bold">not</span> be used for brackets in modern notation that indicate notes that
                                 were part of a ligature in the original source.
                              </p>
                           </td>
