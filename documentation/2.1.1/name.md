                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;name&gt; </span>Proper
                              noun or noun phrase.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.nameLike">model.nameLike</a></div>
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">name</span>
{
   ...
   ( text | <a class="link_odd" href="/documentation/2.1.1/model.textphraseLike">model.textphraseLike</a> | <a class="link_odd" href="/documentation/2.1.1/model.editLike">model.editLike</a> | <a class="link_odd" href="/documentation/2.1.1/model.transcriptionLike">model.transcriptionLike</a> )*
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>Contains the name of an entity that is difficult
                                 to tag more specifically as a <a class="link_odd_elementSpec" href="/documentation/2.1.1/corpName">corpName</a>, <a class="link_odd_elementSpec" href="/documentation/2.1.1/geogName">geogName</a>, <a class="link_odd_elementSpec" href="/documentation/2.1.1/persName">persName</a>, or
                                 <a class="link_odd_elementSpec" href="/documentation/2.1.1/title">title</a>. The <a class="link_odd_elementSpec" href="/documentation/2.1.1/name">name</a>
                                 ...
                                 necessary. For example, the <a class="link_odd_elementSpec" href="/documentation/2.1.1/name">name</a> element might be
                                 used when it is not clear whether the name "Bach" refers to a person or a
                                 geographic feature. The <a class="link_odd_elementSpec" href="/documentation/2.1.1/name">name</a> element may be used
                                 for an individual, such as 'Henry VIII, King of England'; a corporate body, such
                                 as 'The Beatles'; a geographical place; or a generative mechanical process. When
                                 name parts are needed, use <a class="link_odd_elementSpec" href="/documentation/2.1.1/name">name</a> sub-elements. The
                                 recommended values for the <span class="att">type</span> attribute are: pers,
                                 corp, place, process. The <a class="link_odd_elementSpec" href="/documentation/2.1.1/date">date</a> sub-element is
                                 available within <a class="link_odd_elementSpec" href="/documentation/2.1.1/name">name</a> in order to record any
                                 dates, associated with the name, i.e., birth and death in the case of persons or
                                 ...
                                 Geographic Names (TGN) or Library of Congress Name Authority File (LCNAF), may be
                                 recorded using the <span class="att">authority</span> attribute.
                              </p>
                           </td>
