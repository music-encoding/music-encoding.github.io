            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.BEAM">data.BEAM</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.BEAM</span> Beam attribute values: initial,
                              medial, terminal. Nested beaming is permitted.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_macroSpec" href="/documentation/2.1.1/data.BEAMS">data.BEAMS</a></div>
                           </td>
...
data.BEAM = token { pattern = "[i|m|t][1-6]" }</pre></td>
