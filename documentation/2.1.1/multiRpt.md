                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;<span class="emptySlash">multiRpt</span>&gt; </span>(multiple repeat) – Multiple repeated measures.
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">multiRpt</span>
{
   ...
   <a class="link_odd" href="/documentation/2.1.1/att.multiRpt.log">att.multiRpt.log.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.multiRpt.vis">att.multiRpt.vis.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.multiRpt.ges">att.multiRpt.ges.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.multiRpt.anl">att.multiRpt.anl.attributes</a>,
   empty
}</pre></td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>In modern publishing practice, repeats of more
                                 than two measures should be written out using repeat signs. This element, however,
                                 is provided for handling non-standard practices often found in manuscript. The
                                 <span class="att">num</span> attribute records the number of measures to be
                                 repeated.
                              </p>
                           </td>
