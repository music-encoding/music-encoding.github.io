            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.mensur.log">att.mensur.log</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.mensur.log</span> Logical domain attributes.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_elementSpec" href="/documentation/2.1.1/mensur">mensur</a>
                              <a class="link_odd_elementSpec" href="/documentation/2.1.1/mensuration">mensuration</a></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">dot</td>
                                    
                                    <td class="odd_value">specifies whether a dot is to be added to the base
                                       symbol.
                                       <table class="attDef">
