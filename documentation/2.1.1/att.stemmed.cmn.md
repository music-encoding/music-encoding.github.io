            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.stemmed.cmn">att.stemmed.cmn</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.stemmed.cmn</span> Attributes that describe the properties of stemmed features;
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.stemmed">att.stemmed</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/att.chord.vis">att.chord.vis</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/chord">chord</a>] </span>
                                 <a class="link_odd_classSpec" href="/documentation/2.1.1/att.note.vis">att.note.vis</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/note">note</a>]
                                    </span>] </span></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">stem.mod</td>
                                    
                                    <td class="odd_value">encodes any stem "modifiers"; that is, symbols rendered on
                                       the stem, such as tremolo or Sprechstimme indicators.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.STEMMODIFIER">data.STEMMODIFIER</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">stem.with</td>
                                    
                                    <td class="odd_value">contains an indication of which staff a note or chord that
                                       logically belongs to the current staff should be visually placed on; that is,
