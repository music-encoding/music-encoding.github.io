                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;choice&gt; </span>Groups
...
element choice { <a class="link_odd" href="/documentation/2.1.1/att.common">att.common.attributes</a>, <a class="link_odd" href="/documentation/2.1.1/model.choicePart">model.choicePart</a>* }</pre></td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>Because the children of a <a class="link_odd_elementSpec" href="/documentation/2.1.1/choice">choice</a> element all represent alternative ways of encoding the
                                 same sequence, it is natural to think of them as mutually exclusive. However,
                                 there may be cases where a full representation of a text requires the alternative
                                 encodings to be considered as parallel. Note also that <a class="link_odd_elementSpec" href="/documentation/2.1.1/choice">choice</a> elements may be recursively nested.
                              </p>
                           </td>
