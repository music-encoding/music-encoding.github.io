            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.MIDIVALUE">data.MIDIVALUE</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.MIDIVALUE</span> MIDI values in the following
                              range.
                           </td>
...
data.MIDIVALUE = xsd:nonNegativeInteger { maxInclusive = "127" }</pre></td>
