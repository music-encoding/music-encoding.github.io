            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.mensural.vis">att.mensural.vis</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.mensural.vis</span> Used
                              by staffDef and scoreDef to provide default values for attributes in the visual
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.scoreDef.vis.mensural">att.scoreDef.vis.mensural</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/att.scoreDef.vis">att.scoreDef.vis</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/scoreDef">scoreDef</a>] </span>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.staffDef.vis.mensural">att.staffDef.vis.mensural</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/att.staffDef.vis">att.staffDef.vis</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/staffDef">staffDef</a>] </span>] </span></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">mensur.color</td>
                                    
                                    <td class="odd_value">records the color of the mensuration sign. Do not confuse
                                       this with the musical term 'color' as used in pre-CMN notation.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">mensur.form</td>
                                    
                                    <td class="odd_value">indicates whether the base symbol is written vertically or
                                       horizontally.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">mensur.loc</td>
                                    
                                    <td class="odd_value">holds the staff location of the mensuration sign.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">mensur.orient</td>
                                    
                                    <td class="odd_value">describes the rotation or reflection of the base
                                       symbol.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.ORIENTATION">data.ORIENTATION</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">mensur.size</td>
                                    
                                    <td class="odd_value">describes the relative size of the mensuration sign.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.SIZE">data.SIZE</a></code></td>
