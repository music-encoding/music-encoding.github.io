                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;layerDef&gt;
                                 </span>(layer definition) – Container for layer meta-information.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.layerDefLike">model.layerDefLike</a></div>
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div class="specChildren">
                                    <div class="specChild"><span class="specChildModule">MEI.shared: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/staffDef">staffDef</a></span></div>
                                 </div>
                              </div>
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">layerDef</span>
{
   ...
   <a class="link_odd" href="/documentation/2.1.1/att.layerDef.log">att.layerDef.log.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.layerDef.vis">att.layerDef.vis.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.layerDef.ges">att.layerDef.ges.attributes</a>,
   <a class="link_odd" href="/documentation/2.1.1/att.layerDef.anl">att.layerDef.anl.attributes</a>,
   ...
   <a class="link_odd" href="/documentation/2.1.1/model.instrDefLike">model.instrDefLike</a>*
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div xml:space="preserve" class="pre"><br /><span data-indentation="1" class="element">&lt;sch:rule <span class="attribute">context</span>="<span class="attributevalue">mei:layerDef</span>"&gt;</span><br /><br /><span data-indentation="2" class="element">&lt;sch:assert <span class="attribute">test</span>="<span class="attributevalue">number(@n) = round(number(@n))</span>"&gt;</span>An n attribute with a single integer<br /> value must be present.<span data-indentation="2" class="element">&lt;/sch:assert&gt;</span><br /><span data-indentation="1" class="element">&lt;/sch:rule&gt;</span></div>
                           </td>
