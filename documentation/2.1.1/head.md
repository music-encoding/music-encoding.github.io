                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;head&gt;
                                 </span>(heading) – Contains any heading, for example, the title of a section of
                              text, or the heading of a list.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.headLike">model.headLike</a></div>
                           </td>
                              ...
                              <div class="parent">
                                 <div class="specChildren">
                                    <div class="specChild"><span class="specChildModule">MEI.header: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/contents">contents</a>
                                          ...
                                          <a class="link_odd_elementSpec" href="/documentation/2.1.1/perfMedium">perfMedium</a></span></div>
                                    <div class="specChild"><span class="specChildModule">MEI.shared: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/biblList">biblList</a>
                                          ...
                                          <a class="link_odd_elementSpec" href="/documentation/2.1.1/incip">incip</a></span></div>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">head</span>
{
   ...
   ( text | <a class="link_odd" href="/documentation/2.1.1/model.textphraseLike">model.textphraseLike</a> | <a class="link_odd" href="/documentation/2.1.1/model.editLike">model.editLike</a> | <a class="link_odd" href="/documentation/2.1.1/model.transcriptionLike">model.transcriptionLike</a> )*
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>When <a class="link_odd_elementSpec" href="/documentation/2.1.1/head">head</a> is
                                 used, it should be the first sub-element, followed by one or more other
                                 elements.
                              </p>
                           </td>
