            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.timestamp2.musical">att.timestamp2.musical</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.timestamp2.musical</span> Attributes that record a time stamp for the end of
                              an event in terms of musical time.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">tstamp2</td>
                                    
                                    <td class="odd_value">encodes the ending point of an event in terms of musical
                                       time, i.e., a count of measures plus a beat location.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.MEASUREBEAT">data.MEASUREBEAT</a></code></td>
