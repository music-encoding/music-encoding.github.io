            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.visibility">att.visibility</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.visibility</span> Attributes describing whether a feature should be
                              displayed.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.chord.vis">att.chord.vis</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/chord">chord</a>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.layer.vis">att.layer.vis</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/layer">layer</a>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.layerDef.vis">att.layerDef.vis</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/layerDef">layerDef</a>] </span>
                              ...
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.staff.vis">att.staff.vis</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/staff">staff</a>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.staffDef.vis">att.staffDef.vis</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/staffDef">staffDef</a>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.staffGrp.vis">att.staffGrp.vis</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/staffGrp">staffGrp</a>] </span>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">visible</td>
                                    
                                    <td class="odd_value">indicates if a feature should be rendered when the
                                       notation is presented graphically or sounded when it is presented in an aural
                                       form.
                                       <table class="attDef">
