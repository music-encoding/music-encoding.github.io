            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.DEGREES">data.DEGREES</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.DEGREES</span> 360th-unit measure of a
                              circle's circumference; optionally signed decimal number between -360 and 360.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><span lang="en">Element: </span><ul>
                                    ...
                                    <li><a class="link_odd_elementSpec" href="/documentation/2.1.1/rend">rend</a>/@rotation
                                    </li>
...
data.DEGREES = xsd:decimal { maxInclusive = "360.0" minInclusive = "-360.0" }</pre></td>
