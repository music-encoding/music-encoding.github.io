            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.distances">att.distances</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.distances</span> Attributes that describe distance from the staff.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">dynam.dist</td>
                                    
                                    <td class="odd_value">records the default distance from the staff for dynamic
                                       marks.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">harm.dist</td>
                                    
                                    <td class="odd_value">records the default distance from the staff of harmonic
                                       indications, such as guitar chord grids or functional labels.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">text.dist</td>
                                    
                                    <td class="odd_value">determines how far from the staff to render text
                                       elements.
                                       <table class="attDef">
