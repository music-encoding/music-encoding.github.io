                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;quote&gt; </span>(block
                              quote) – A formatting element that designates an extended quotation; that is, a
                              passage attributed to a source external to the text and normally set off from the
                              text by spacing or other typographic distinction.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.quoteLike">model.quoteLike</a></div>
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">quote</span>
{
   ...
   ( text | <a class="link_odd" href="/documentation/2.1.1/model.paracontentPart">model.paracontentPart</a> | <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/p">p</a> )*
}</pre></td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>The source for the quote may be included in the
                                 optional <a class="link_odd_elementSpec" href="/documentation/2.1.1/bibl">bibl</a> sub-element. Use <a class="link_odd_elementSpec" href="/documentation/2.1.1/rend">rend</a> for words that are enclosed in quotation marks for emphasis
                                 or for a short quoted phrase that occurs within a line of text.
                              </p>
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>This element is modelled on elements found in
                                 HTML, TEI, and EAD standards.
                              </p>
                           </td>
