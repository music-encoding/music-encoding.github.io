            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.DURATION.additive">data.DURATION.additive</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.DURATION.additive</span> records duration
                              using optionally dotted, relative durational values provided by the data.DURATION
                              datatype. When the duration is "irrational", as is sometimes the case with tuplets,
