            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.PAGE.PANELS">data.PAGE.PANELS</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.PAGE.PANELS</span> The number of panels per
                              page.
                           </td>
...
data.PAGE.PANELS =
   xsd:positiveInteger { minInclusive = "1" maxInclusive = "2" }</pre></td>
