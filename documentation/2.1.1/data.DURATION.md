            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.DURATION">data.DURATION</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.DURATION</span> Logical, that is, written,
...
data.DURATION = <a class="link_odd" href="/documentation/2.1.1/data.DURATION.cmn">data.DURATION.cmn</a> | <a class="link_odd" href="/documentation/2.1.1/data.DURATION.mensural">data.DURATION.mensural</a></pre></td>
