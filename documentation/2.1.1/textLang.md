                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;textLang&gt;
                                 </span>(text language) – Identifies the languages and writing systems within the
                              work described by a bibliographic description, not the language of the
                              description.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_value">(main language) supplies a code which identifies the chief
                                       language used in the bibliographic work.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_value">(other languages) one or more codes identifying any other
                                       languages used in the bibliographic work.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg"> list { xsd:language+ }</code></td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">textLang</span>
{
   ...
   attribute [http://www.tei-c.org/ns/1.0]mainLang { xsd:language }?,
   attribute [http://www.tei-c.org/ns/1.0]otherLangs { list { xsd:language+ } }?,
