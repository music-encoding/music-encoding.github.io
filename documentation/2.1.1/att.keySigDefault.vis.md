            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.keySigDefault.vis">att.keySigDefault.vis</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.keySigDefault.vis</span> Used by staffDef and scoreDef to provide default
                              values for attributes in the visual domain related to key signatures.
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">key.sig.show</td>
                                    
                                    <td class="odd_value">indicates whether the key signature should be
                                       displayed.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">key.sig.showchange</td>
                                    
                                    <td class="odd_value">determines whether cautionary accidentals should be
                                       displayed at a key change.
                                       <table class="attDef">
