            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.TIES">data.TIES</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.TIES</span> One or more from the list given
                              in the definition of data.TIE.
                           </td>
...
data.TIES = list { <a class="link_odd" href="/documentation/2.1.1/data.TIE">data.TIE</a>+ }</pre></td>
