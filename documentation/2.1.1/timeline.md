                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td colspan="2" class="wovenodd-col2"><span class="label">&lt;timeline&gt;
                                 </span>Provides a set of ordered points in time to which musical elements can be
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">avref</td>
                                    
                                    <td class="odd_value">holds the identifier of an &lt;avFile&gt; element that
                                       references an external digital media file.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_value">designates the origin of the timeline, i.e. the
                                       &lt;when&gt; element associated with the beginning of the timeline.
                                       <table class="attDef">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.alignLike">model.alignLike</a></div>
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div class="specChildren">
                                    <div class="specChild"><span class="specChildModule">MEI.shared: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/music">music</a>
                                          <a class="link_odd_elementSpec" href="/documentation/2.1.1/scoreDef">scoreDef</a></span></div>
                                 </div>
                              </div>
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="specChildren">
                                 <div class="specChild"><span class="specChildModule">MEI.linkalign: </span><span class="specChildElements"><a class="link_odd_elementSpec" href="/documentation/2.1.1/when">when</a></span></div>
                              </div>
                           </td>
...
<span class="rnc_keyword">element</span> <span class="rnc_nc">timeline</span>
{
   ...
   attribute [http://www.tei-c.org/ns/1.0]avref { <a class="link_odd" href="/documentation/2.1.1/data.URI">data.URI</a> }?,
   attribute [http://www.tei-c.org/ns/1.0]origin { <a class="link_odd" href="/documentation/2.1.1/data.URI">data.URI</a> },
   <a class="link_odd_elementSpec link_odd" href="/documentation/2.1.1/when">when</a>*
}</pre></td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <!-- -->
                              <p>The <span class="att">origin</span> attribute
                                 designates the origin of the timeline, i.e., the time at which it begins. It must
                                 point to one of the <a class="link_odd_elementSpec" href="/documentation/2.1.1/when">when</a> elements in its content.
                                 The <span class="att">avref</span> attribute is provided in order to link the
