            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.coded">att.coded</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.coded</span> Attributes
                              that capture coded values.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_elementSpec" href="/documentation/2.1.1/ensemble">ensemble</a>
                              ...
                              <a class="link_odd_elementSpec" href="/documentation/2.1.1/resp">resp</a></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">code</td>
                                    
                                    <td class="odd_value">captures one or more coded values for the textual content
                                       of this element.
                                       <table class="attDef">
