            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.CLEFSHAPE">data.CLEFSHAPE</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.CLEFSHAPE</span> Clef shape attribute values
                              (Read, p.53-56). Some values correspond to the Unicode Standard.
                           </td>
...
data.CLEFSHAPE = "G" | "GG" | "F" | "C" | "perc" | "TAB"</pre></td>
