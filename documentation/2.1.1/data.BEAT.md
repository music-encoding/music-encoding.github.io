            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.BEAT">data.BEAT</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.BEAT</span> A beat location, i.e.,
                              [0-9]+(\.?[0-9]*)? The value must fall between 0 and the numerator of the time
                              signature + 1, where 0 represents the left bar line and the upper boundary
...
data.BEAT = xsd:decimal { minInclusive = "0" }</pre></td>
