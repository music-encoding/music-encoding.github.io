            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.stemmed">att.stemmed</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.stemmed</span> Attributes that describe the properties of stemmed features;
                              that is, chords and notes.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.chord.vis">att.chord.vis</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/chord">chord</a>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.note.vis">att.note.vis</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/note">note</a>]
                                 </span></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">stem.dir</td>
                                    
                                    <td class="odd_value">describes the direction of a stem.
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.STEMDIRECTION">data.STEMDIRECTION</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">stem.len</td>
                                    
                                    <td class="odd_value">encodes the stem length.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">stem.pos</td>
                                    
                                    <td class="odd_value">records the position of the stem in relation to the note
                                       head(s).
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.STEMPOSITION">data.STEMPOSITION</a></code></td>
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">stem.x</td>
                                    
                                    <td class="odd_value">records the output x coordinate of the stem's attachment
                                       point.
                                       <table class="attDef">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">stem.y</td>
                                    
                                    <td class="odd_value">records the output y coordinate of the stem's attachment
                                       point.
                                       <table class="attDef">
