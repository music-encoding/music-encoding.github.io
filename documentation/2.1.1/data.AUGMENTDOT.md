            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.AUGMENTDOT">data.AUGMENTDOT</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.AUGMENTDOT</span> Dots attribute values
                              (number of augmentation dots) (Read, 113-119, ex. 8-21).
                           </td>
...
data.AUGMENTDOT = xsd:nonNegativeInteger { maxInclusive = "4" }</pre></td>
