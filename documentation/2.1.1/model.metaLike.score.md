            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="model.metaLike.score">model.metaLike.score</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">model.metaLike.score</span> groups meta-data elements that may appear in running
                              headers or footers of a score.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_elementSpec" href="/documentation/2.1.1/pgFoot">pgFoot</a>
                              ...
                              <a class="link_odd_elementSpec" href="/documentation/2.1.1/pgHead2">pgHead2</a></td>
