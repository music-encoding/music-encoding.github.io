            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="data.DURATION.gestural">data.DURATION.gestural</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2"><span class="label">data.DURATION.gestural</span> Performed duration
                              attribute values.
                           </td>
...
data.DURATION.gestural =
   list { token { pattern = "[0-9]+(\.)*r" }+ }
 | token { pattern = "[0-9]+((\.)*p|(\.[0-9]+)?(b|s))" }
 | <a class="link_odd" href="/documentation/2.1.1/data.DURATION.mensural">data.DURATION.mensural</a></pre></td>
