            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="model.layerPart.neumes">model.layerPart.neumes</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">model.layerPart.neumes</span> groups notated events that may appear at the layer
                              level in the neume repertoire.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/model.eventLike.neumes">model.eventLike.neumes</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/ineume">ineume</a>
                                 <a class="link_odd_elementSpec" href="/documentation/2.1.1/uneume">uneume</a>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/model.syllableLike">model.syllableLike</a><span class="showmembers2"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/syllable">syllable</a>]
                                 </span></td>
