            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     <h3 class="oddSpec status_stable" id="att.beamed">att.beamed</h3>
                     <table class="wovenodd">
                        
                        <tr>
                           
                           <td colspan="2" class="wovenodd-col2"><span class="label">att.beamed</span> Attributes
                              that indicate whether an event lies under a beam.
                           </td>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2"><a class="link_odd_classSpec" href="/documentation/2.1.1/att.chord.log.cmn">att.chord.log.cmn</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/att.chord.log">att.chord.log</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/chord">chord</a>] </span>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.note.log.cmn">att.note.log.cmn</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/att.note.log">att.note.log</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/note">note</a>] </span>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.rest.log.cmn">att.rest.log.cmn</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/att.rest.log">att.rest.log</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/rest">rest</a>] </span>] </span>
                              <a class="link_odd_classSpec" href="/documentation/2.1.1/att.space.log.cmn">att.space.log.cmn</a><span class="showmembers2"> [<a class="link_odd_classSpec" href="/documentation/2.1.1/att.space.log">att.space.log</a><span class="showmembers3"> [<a class="link_odd_elementSpec" href="/documentation/2.1.1/space">space</a>] </span>] </span></td>
                           ...
                           <td class="wovenodd-col2">
                              <table class="attList">
                                 ...
                                 <tr>
                                    ...
                                    <td class="odd_label">beam</td>
                                    
                                    <td class="odd_value">indicates that this event is "under a beam".
                                       <table class="attDef">
                                          ...
                                          <tr>
                                             ...
                                             <td class="odd_value"><code class="eg">
                                                   <a class="link_odd" href="/documentation/2.1.1/data.BEAMS">data.BEAMS</a></code></td>
