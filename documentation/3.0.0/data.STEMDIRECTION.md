                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">data.STEMDIRECTION</span> Stem direction.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.stems">att.stems</a> (@stem.dir)
                              </div>
                           </td>
                        </tr>
                        <tr>
                                    ...
                                    <div class="indent2">
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;macroRef 
                                             ...
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/data.STEMDIRECTION.basic">data.STEMDIRECTION.basic</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;macroRef 
                                             <span class="attribute">key=</span>
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/data.STEMDIRECTION.extended">data.STEMDIRECTION.extended</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
