                  ...
                  <div class="elementSpec">
                     ...
                     <table class="wovenodd">
                           ...
                           <td class="wovenodd-col2">
                              <div class="attributeDef">
                                 ...
                                 <span class="attributeClasses">
                                    <a class="link_odd" href="/documentation/3.0.0/att.mediabounds">att.mediabounds</a>
                                 </span>
                              </div>
                              <div class="attributeDef">
                                 ...
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/data.BETYPE">data.BETYPE</a>
                                 .
                                    ...
                                    <div class="indent2">
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;rng:ref 
                                             ...
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/avFile">avFile</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
                                    ...
                                    <div class="indent2">
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;rng:ref 
                                             <span class="attribute">name=</span>
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/when">when</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <p>This element is analogous to the 
                                 <a class="link_odd_elementSpec" href="/documentation/3.0.0/zone">zone</a> element in the facsimile
                                 module.
                              </p>
                           </td>
                        </tr>
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div>
                                 <div>When @begin or @end is used, @betype should appear on clip or one of its ancestors.</div>
                              </div>
                              <div xml:space="preserve" class="pre">
                                 <div class="indent1">
                                    <span data-indentation="1" class="element">&lt;sch:rule 
                                       <span class="attribute">context=</span>
                                       <span class="attributevalue">"mei:clip[@begin or @end]"</span>&gt;
                                    </span>
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;sch:assert 
                                          ...
                                          <span class="attributevalue">"@betype or ancestor::mei:*[@betype]"</span>&gt;
                                       </span>When @begin or
