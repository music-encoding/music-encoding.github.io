                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">model.fingeringLike</span> Groups elements that capture performance instructions regarding the use of the fingers
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    ...
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/fingGrp">fingGrp</a> (direct members of model.fingeringLike)
                                 </div>
                              </div>
                           </td>
                        </tr>
