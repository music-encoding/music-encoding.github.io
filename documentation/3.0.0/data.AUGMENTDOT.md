                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">data.AUGMENTDOT</span> Dots attribute values (number of augmentation dots) (Read, 113-119, ex. 8-21).
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.augmentdots">att.augmentdots</a> (@dots), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.mmtempo">att.mmtempo</a> (@mm.dots)
                              </div>
                           </td>
                        </tr>
                        <tr>
