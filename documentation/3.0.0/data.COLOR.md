                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.beaming.vis">att.beaming.vis</a> (@beam.color), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.cleffing.vis">att.cleffing.vis</a> (@clef.color), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.color">att.color</a> (@color), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.mensural.vis">att.mensural.vis</a> (@mensur.color), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.noteheads">att.noteheads</a> (@head.color), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.staffDef.vis">att.staffDef.vis</a> (@lines.color)
                              </div>
                           </td>
                        </tr>
                        <tr>
                                    ...
                                    <div class="indent2">
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;macroRef 
                                             ...
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/data.COLORNAMES">data.COLORNAMES</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;macroRef 
                                             <span class="attribute">key=</span>
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/data.COLORVALUES">data.COLORVALUES</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
