                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.layer.log">att.layer.log</a>)
                                    </span>
                                 </div>
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/staff">staff</a>
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.staff.log">att.staff.log</a>)
                                    </span>
                                 </div>
                              </div>
                           </td>
