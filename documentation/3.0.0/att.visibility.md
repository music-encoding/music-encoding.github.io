                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 ...
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.keySig.vis">att.keySig.vis</a>)
                                    </span>
                                 </div>
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/layer">layer</a>
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.layer.vis">att.layer.vis</a>)
                                    </span>
                                 </div>
                                 <div>
                                 ...
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.staff.vis">att.staff.vis</a>)
                                    </span>
                                 </div>
                                 <div>
                                 ...
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.staffGrp.vis">att.staffGrp.vis</a>)
                                    </span>
                                 </div>
                                 <div>
