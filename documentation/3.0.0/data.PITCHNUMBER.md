                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">data.PITCHNUMBER</span> Pnum (pitch number, e.g. MIDI) attribute values.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.note.ges">att.note.ges</a> (@pnum)
                              </div>
                           </td>
                        </tr>
                        <tr>
