            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div class="classSpec att">
                     <h3 id="att.meterSigGrp.vis">att.meterSigGrp.vis</h3>
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.meterSigGrp.vis</span> Visual domain attributes.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/meterSigGrp">meterSigGrp</a> (direct member of att.meterSigGrp.vis)
                                 </div>
                              </div>
                           </td>
                        </tr>
