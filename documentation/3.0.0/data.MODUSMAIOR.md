                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">data.MODUSMAIOR</span> Maxima-long relationship values.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.mensural.shared">att.mensural.shared</a> (@modusmaior)
                              </div>
                           </td>
                        </tr>
                        <tr>
