                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.clef.log">att.clef.log</a>)
                                    </span>
                                 </div>
                                 <div>
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;rng:ref 
                                             ...
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/data.OCTAVE.DIS">data.OCTAVE.DIS</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
