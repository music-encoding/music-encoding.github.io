                                       ...
                                       <div class="indent3">
                                          ...
                                          <div class="indent4">
                                             <span data-indentation="4" class="element">&lt;rng:ref 
                                                ...
                                                <span class="attributevalue">"
                                                   <a class="link_odd" href="/documentation/3.0.0/unpub">unpub</a>"
                                                </span>/&gt;
                                             </span>
                                          </div>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <p>When an item is unpublished, use only the 
                                 <a class="link_odd_elementSpec" href="/documentation/3.0.0/unpub">unpub</a> sub-element.This element is modelled on an element in the Text Encoding Initiative
                                 (TEI)
                                 standard.
                              </p>
                           </td>
