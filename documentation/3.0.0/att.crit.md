                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.crit</span> Attributes common to all elements representing variant readings.
                           </td>
                        </tr>
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    ...
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/rdg">rdg</a> (direct members of att.crit)
                                 </div>
                              </div>
                           </td>
                        </tr>
                              ...
                              <div xml:space="preserve" class="pre">
                                 <div class="indent1">
                                    <span data-indentation="1" class="element">&lt;attDef 
                                       ...
                                       <span class="attributevalue">"cause"</span> 
                                       <span class="attribute">usage=</span>
                                       <span class="attributevalue">"opt"</span>&gt;
                                    </span>
                                    
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;desc&gt;</span>Classifies the cause for the variant reading, according to any appropriate typology
                                       of possible origins.
