            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div class="classSpec att">
                     <h3 id="att.mSpace.anl">att.mSpace.anl</h3>
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.mSpace.anl</span> Analytical domain attributes. Use the n attribute to explicitly encode this measure's
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/mSpace">mSpace</a> (direct member of att.mSpace.anl)
                                 </div>
                              </div>
                           </td>
                        </tr>
