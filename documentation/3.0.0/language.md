                  ...
                  <div class="elementSpec">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <p>Textual elements may be related to this element via their 
                                 <span class="att">xml:lang</span> attribute,
                                 which normally takes the form of a code, drawn from a coded list, such as ISO639-2b.
                                 The
                                 name and web location of the authorizing list may be encoded in the 
                                 <span class="att">authority</span>
                                 attribute and the 
                                 <span class="att">authURI</span> attribute, respectively.This element is modelled on elements in the Text Encoding
                                 Initiative (TEI) and Encoded
