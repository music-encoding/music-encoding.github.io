                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.numberplacement</span> Attributes that record the placement and visibility of numbers that accompany a bowed
                              tremolo or tuplet.
                           </td>
                        </tr>
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.bTrem.vis">att.bTrem.vis</a>)
                                    </span>
                                 </div>
                                 <div>
