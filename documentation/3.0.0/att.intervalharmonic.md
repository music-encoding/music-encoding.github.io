                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/chordMember">chordMember</a> (direct member of att.intervalharmonic)
                                 </div>
                                 <div>
                                 ...
                                 <div>
                                    <span>
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.intervallicdesc">att.intervallicdesc</a> (no elements directly inheriting from this class)
                                    </span>
                                 </div>
                              </div>
                           </td>
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;rng:ref 
                                             ...
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/data.INTERVAL.HARMONIC">data.INTERVAL.HARMONIC</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
