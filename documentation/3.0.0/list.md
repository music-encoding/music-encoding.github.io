                           ...
                           <td class="wovenodd-col2">
                              ...
                              <div class="attributeDef">
                                 ...
                                 <span class="attributeDesc">Used to indicate the format of a list. In a "simple" list, 
                                    ...
                                    the
                                    start of each 
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/item">item</a>. In an "ordered" list, the sequence of the
                                    items is important, and each 
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/li">li</a> is lettered or numbered. Style
                                    ...
                                    <div class="indent2">
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;rng:ref 
                                             <span class="attribute">name=</span>
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/li">li</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
