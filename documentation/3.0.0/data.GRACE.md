                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">data.GRACE</span> Do grace notes get time from the current (acc) or previous (unacc) one?.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.graced">att.graced</a> (@grace)
                              </div>
                           </td>
                        </tr>
                        <tr>
