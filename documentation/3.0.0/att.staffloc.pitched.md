                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <span>
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.accid.vis.mensural">att.accid.vis.mensural</a> (no elements directly inheriting from this class)
                                    </span>
                                 </div>
                                 <div>
                                 ...
                                 <div>
                                    <span>
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.dot.vis.mensural">att.dot.vis.mensural</a> (no elements directly inheriting from this class)
                                    </span>
                                 </div>
                                 <div>
