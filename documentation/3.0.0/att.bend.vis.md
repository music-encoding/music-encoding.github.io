            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div class="classSpec att">
                     <h3 id="att.bend.vis">att.bend.vis</h3>
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.bend.vis</span> Visual domain attributes. If the bulge or bezier attributes are present, the bend
                              should
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/bend">bend</a> (direct member of att.bend.vis)
                                 </div>
                              </div>
                           </td>
                        </tr>
