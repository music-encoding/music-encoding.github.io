                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    ...
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/textLang">textLang</a> (direct members of model.biblPart)
                                 </div>
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/model.editionLike">model.editionLike</a>)
                                    </span>
                                 </div>
                                 <div>
                                 ...
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/model.respLikePart">model.respLikePart</a>)
                                    </span>
                                 </div>
                              </div>
                           </td>
