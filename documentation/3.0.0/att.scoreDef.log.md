                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/scoreDef">scoreDef</a> (direct member of att.scoreDef.log)
                                 </div>
                              </div>
                           </td>
                        </tr>
                                 ...
                                 <div class="indent1">
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;memberOf 
                                          <span class="attribute">key=</span>
                                          <span class="attributevalue">"
                                             <a class="link_odd" href="/documentation/3.0.0/att.scoreDef.log.cmn">att.scoreDef.log.cmn</a>"
                                          </span>/&gt;
                                       </span>
                                    </div>
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;memberOf 
                                          <span class="attribute">key=</span>
                                          <span class="attributevalue">"
                                             <a class="link_odd" href="/documentation/3.0.0/att.scoreDef.log.mensural">att.scoreDef.log.mensural</a>"
                                          </span>/&gt;
                                       </span>
                                    </div>
