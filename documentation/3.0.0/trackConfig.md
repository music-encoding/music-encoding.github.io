                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              ...
                              <div class="attributeDef">
                                 ...
                                 <span class="attributeClasses">
                                    <a class="link_odd" href="/documentation/3.0.0/trackConfig">trackConfig</a>
                                 </span>
                              </div>
                              <div class="attributeDef">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <p>The number of apparent playback channels can differ from the number of physical channels
                                 ...
                                 sound
                                 medium, while the 
                                 <a class="link_odd_elementSpec" href="/documentation/3.0.0/soundChan">soundChan</a> element should be used to state that
