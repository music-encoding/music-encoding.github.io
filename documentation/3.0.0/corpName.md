                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <p>Examples of corporate entities include names of associations, institutions, business
                                 ...
                                 fairs, and ships. Usually, secondary name parts are encoded in 
                                 <a class="link_odd_elementSpec" href="/documentation/3.0.0/corpName">corpName</a> sub-elements. The name of the list from which a controlled value is taken
