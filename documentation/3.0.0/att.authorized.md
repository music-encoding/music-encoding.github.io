                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    ...
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/trackConfig">trackConfig</a> (direct members of att.authorized)
                                 </div>
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.name">att.name</a>)
                                    </span>
                                 </div>
                              </div>
                           </td>
