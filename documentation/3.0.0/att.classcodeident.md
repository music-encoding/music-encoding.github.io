                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.classcodeident</span> 
                           </td>
                        </tr>
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    ...
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/termList">termList</a> (direct members of att.classcodeident)
                                 </div>
                              </div>
                           </td>
                        </tr>
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="attributeDef">
                                 ...
                                 <span class="attributeDesc">Contains a reference to the controlled vocabulary from which the term is drawn. The
                                 ...
                                 <span class="attributeClasses">
                                    <a class="link_odd" href="/documentation/3.0.0/att.classcodeident">att.classcodeident</a>
                                 </span>
                              </div>
                           </td>
                        </tr>
                                          ...
                                          <div class="indent4">
                                             ...
                                             <div class="indent5">
                                                <span data-indentation="5" class="element">&lt;sch:assert 
                                                   ...
                                                   <span class="attributevalue">"warning"</span> 
                                                   <span class="attribute">test=</span>
                                                   <span class="attributevalue">"every $i in tokenize(., '\s+') satisfies substring($i,2)=//mei:classCode/@xml:id"</span>&gt;
                                                </span>The value in @classcode should correspond to the @xml:id attribute of a classCode
                                                element.
                                                <span data-indentation="5" class="element">&lt;/sch:assert&gt;</span>
                                             </div>
