                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.curvature</span> Attributes that describe curvature.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/curve">curve</a> (direct member of att.curvature)
                                 </div>
                                 <div>
                                             ...
                                             <div class="indent5">
                                                <span data-indentation="5" class="element">&lt;rng:ref 
                                                   ...
                                                   <span class="attributevalue">"
                                                      <a class="link_odd" href="/documentation/3.0.0/data.PERCENT">data.PERCENT</a>"
                                                   </span>/&gt;
                                                </span>
                                             </div>
