                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.keySig.log">att.keySig.log</a> (@sig.mixed), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.keySigDefault.log">att.keySigDefault.log</a> (@key.sig.mixed)
                              </div>
                           </td>
                        </tr>
                        <tr>
                                 ...
                                 <div class="indent1">
                                    ...
                                    <div class="indent2">
                                       ...
                                       <div class="indent3">
                                          ...
                                          <div class="indent4">[a-g][0-9](s|f|ss|x|ff|xs|sx|ts|tf|n|nf|ns|su|sd|fu|fd|nu|nd</div>
                                          <div class="indent5">|1qf|3qf|1qs|3qs)</div>
