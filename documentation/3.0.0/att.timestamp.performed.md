                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 ...
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.measure.ges">att.measure.ges</a>)
                                    </span>
                                 </div>
                                 <div>
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;rng:ref 
                                             ...
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/data.DURATION.gestural">data.DURATION.gestural</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
                                    ...
                                    <div class="indent2">
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;rng:ref 
                                             <span class="attribute">name=</span>
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/data.ISOTIME">data.ISOTIME</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
