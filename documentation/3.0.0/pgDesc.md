                  ...
                  <div class="elementSpec">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/model.metaLike.page">model.metaLike.page</a>
                              </div>
                           </td>
                        </tr>
                        <tr>
                                 ...
                                 <div class="indent1">
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;memberOf 
                                          <span class="attribute">key=</span>
                                          <span class="attributevalue">"
                                             <a class="link_odd" href="/documentation/3.0.0/model.metaLike.page">model.metaLike.page</a>"
                                          </span>/&gt;
                                       </span>
                                    </div>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <p>Best practice suggests the use of controlled vocabulary. Don't confuse this element
                                 with
                                 a figure caption. A caption is text primarily intended for display with an illustration.
