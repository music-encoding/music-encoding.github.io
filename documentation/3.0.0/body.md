                  ...
                  <div class="elementSpec">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/model.musicPart">model.musicPart</a>
                              </div>
                           </td>
                        </tr>
                        <tr>
                                 ...
                                 <div class="indent1">
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;memberOf 
                                          <span class="attribute">key=</span>
                                          <span class="attributevalue">"
                                             <a class="link_odd" href="/documentation/3.0.0/model.musicPart">model.musicPart</a>"
                                          </span>/&gt;
                                       </span>
                                    </div>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <p>When the music can be broken into high-level, discrete, linear segments, such as
                                 ...
                                 <a class="link_odd_elementSpec" href="/documentation/3.0.0/mdiv">mdiv</a> elements within
                                 
                                 <a class="link_odd_elementSpec" href="/documentation/3.0.0/body">body</a>. This is the highest level indication of the structure of the
                                 music.
                              </p>
                           </td>
                        </tr>
