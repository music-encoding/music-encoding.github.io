                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.distances">att.distances</a> (@dynam.dist), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.lyricstyle">att.lyricstyle</a> (@lyric.align), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.spacing">att.spacing</a> (@spacing.staff), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.staffDef.vis">att.staffDef.vis</a> (@spacing), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.visualoffset.ho">att.visualoffset.ho</a> (@ho), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.visualoffset.vo">att.visualoffset.vo</a> (@vo), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.visualoffset2.ho">att.visualoffset2.ho</a> (@startho), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.visualoffset2.vo">att.visualoffset2.vo</a> (@startvo)
                              </div>
                           </td>
                        </tr>
                        <tr>
