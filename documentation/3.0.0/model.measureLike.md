            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div class="classSpec model">
                     <h3 id="model.measureLike">model.measureLike</h3>
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">model.measureLike</span> Groups measure-like elements.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_classSpec" href="/documentation/3.0.0/model.sectionPart.cmn">model.sectionPart.cmn</a>
                                 </div>
                                 <div>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/measure">measure</a> (direct member of model.measureLike)
                                 </div>
                              </div>
                           </td>
                        </tr>
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;memberOf 
                                          ...
                                          <span class="attributevalue">"
                                             <a class="link_odd" href="/documentation/3.0.0/model.sectionPart.cmn">model.sectionPart.cmn</a>"
                                          </span>/&gt;
                                       </span>
                                    </div>
