         ...
         <div class="panel-grid-cell" style="width: 65%; float: left;">
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div>
                     <h3>data.SLURDIRECTION</h3>
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">data.SLURDIRECTION</span> Slur direction.</td>
                        </tr>
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec"
                                    href="/documentation/3.0.0/data.SLURDIRECTION">data.SLURDIRECTION</a>
                              </div>
                           </td>
                        </tr>
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <dl>
                                 <dt>up</dt>
                                 <dd>Upward-curving line.</dd>
                                 <dt>down</dt>
                                 <dd>Downward-curving line.</dd>
                              </dl>
                           </td>
                        </tr>
                     </table>
