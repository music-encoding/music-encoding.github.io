                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.phrase.vis</span> Visual domain attributes.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/phrase">phrase</a> (direct member of att.phrase.vis)
                                 </div>
                              </div>
                           </td>
                        </tr>
                                 ...
                                 <div class="indent1">
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;memberOf 
                                          <span class="attribute">key=</span>
                                          <span class="attributevalue">"
                                             <a class="link_odd" href="/documentation/3.0.0/att.phrase.vis.cmn">att.phrase.vis.cmn</a>"
                                          </span>/&gt;
                                       </span>
                                    </div>
