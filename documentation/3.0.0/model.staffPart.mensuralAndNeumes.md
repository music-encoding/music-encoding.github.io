            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div class="classSpec model">
                     <h3 id="model.staffPart.mensuralAndNeumes">model.staffPart.mensuralAndNeumes</h3>
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">model.staffPart.mensuralAndNeumes</span> Groups elements that are components of a staff in the mensural and neume
                              repertoires.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_classSpec" href="/documentation/3.0.0/model.staffPart">model.staffPart</a>
                                 </div>
                              </div>
                           </td>
                        </tr>
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 ...
                                 <div>
                                    <span>
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/model.staffPart.mensural">model.staffPart.mensural</a> (no elements directly inheriting from this class)
                                    </span>
                                 </div>
                                 <div>
                                    <span>
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/model.staffPart.neumes">model.staffPart.neumes</a> (no elements directly inheriting from this class)
                                    </span>
                                 </div>
                              </div>
                           </td>
