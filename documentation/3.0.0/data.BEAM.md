                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">data.BEAM</span> Beam attribute values: initial, medial, terminal. Nested beaming is permitted.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.beamed">att.beamed</a> (@beam)
                              </div>
                           </td>
                        </tr>
                        <tr>
