                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.curverend">att.curverend</a> (@lwidth), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.line.vis">att.line.vis</a> (@width), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.linerend.base">att.linerend.base</a> (@lwidth), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.slurrend">att.slurrend</a> (@slur.lwidth), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.tierend">att.tierend</a> (@tie.lwidth)
                              </div>
                           </td>
                        </tr>
                        <tr>
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;macroRef 
                                             ...
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/data.LINEWIDTHTERM">data.LINEWIDTHTERM</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
