                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              ...
                              <div class="attributeDef">
                                 ...
                                 <span class="attributeDesc">Characterizes the property name.</span>
                                 Allowed values are:
                                 "
                                 <span style="font-weight: 500;">unicode</span>" 
                                 <i>(A registered Unicode normative or informative property name.)</i>,  "
                                 <span style="font-weight: 500;">local</span>" 
                                 <i>(A locally defined name.)</i>
                                 <span class="attributeClasses">
                                    <a class="link_odd" href="/documentation/3.0.0/propName">propName</a>
                                 </span>
                              </div>
                              <div class="attributeDef">
