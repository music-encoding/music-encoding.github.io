                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">data.METERSIGN</span> Meter.sym attribute values for CMN.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.meterSig.log">att.meterSig.log</a> (@sym), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.meterSigDefault.vis">att.meterSigDefault.vis</a> (@meter.sym)
                              </div>
                           </td>
                        </tr>
                        <tr>
