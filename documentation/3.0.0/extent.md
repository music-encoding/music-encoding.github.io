                  ...
                  <div class="elementSpec">
                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <p>Use the 
                                 <a class="link_odd_elementSpec" href="/documentation/3.0.0/dimensions">dimensions</a> element when it is necessary to specify the 
                                 <span class="hi">physical</span> size of materials being described, for example, height and
                                 width.This element is modelled on elements in the Text Encoding Initiative (TEI) and
                                 Encoded
