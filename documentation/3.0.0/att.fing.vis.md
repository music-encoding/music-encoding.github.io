            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div class="classSpec att">
                     <h3 id="att.fing.vis">att.fing.vis</h3>
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.fing.vis</span> Visual domain attributes.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/fing">fing</a> (direct member of att.fing.vis)
                                 </div>
                              </div>
                           </td>
                        </tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <p>If @tstamp2 is not provided, then the extender should be drawn based on the value
                                 of
                                 @tstamp2 on a fingering ancestor.
                              </p>
                           </td>
                        </tr>
                     </table>
