                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              ...
                              <div class="attributeDef">
                                 ...
                                 <span class="attributeUsage">(optional)</span>
                                 <span class="attributeDesc">Records the channel configuration in numeric form.</span>
                                 Value of datatype 
                                 <span style="font-weight: 500;">positiveInteger</span>.
                                 
                                 <span class="attributeClasses">
                                    <a class="link_odd" href="/documentation/3.0.0/soundChan">soundChan</a>
                                 </span>
                              </div>
                              <div class="attributeDef">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <p>The number of apparent playback channels can differ from the number of physical channels
                                 ...
                                 <a class="link_odd_elementSpec" href="/documentation/3.0.0/trackConfig">trackConfig</a> element should capture the existence of two physical
