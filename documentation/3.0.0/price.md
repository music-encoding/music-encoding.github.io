                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="attributeDef">
                                 ...
                                 <span class="attributeDesc">Numeric value capturing a cost. Can only be interpreted in combination with the
                                    currency attribute.
                                 </span>
                                 Value of datatype 
                                 <span style="font-weight: 500;">
                                    a decimal number matching the pattern "[0-9]+\.[0-9]{2}"
                              ...
                              <div class="attributeDef">
                                 <span class="attribute">@currency</span>
                                 <span class="attributeUsage">(optional)</span>
                                 <span class="attributeDesc">Monetary unit.</span>
                                 Value of datatype 
