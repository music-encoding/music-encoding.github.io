         ...
         <div class="panel-grid-cell" style="width: 65%; float: left;">
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div>
                     <h3>data.CURVERENDITION</h3>
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">data.CURVERENDITION</span> Renderings of curves.</td>
                        </tr>
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec"
                                    href="/documentation/3.0.0/data.CURVERENDITION">data.CURVERENDITION</a>
                              </div>
                           </td>
                        </tr>
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <dl>
                                 <dt>narrow</dt>
                                 <dd>Default line width.</dd>
                                 <dt>medium</dt>
                                 <dd>Twice as wide as normal.</dd>
                                 <dt>wide</dt>
                                 <dd>Twice as wide as medium.</dd>
                                 <dt>dashed</dt>
                                 <dd>Dashed.</dd>
                                 <dt>dotted</dt>
                                 <dd>Dotted.</dd>
