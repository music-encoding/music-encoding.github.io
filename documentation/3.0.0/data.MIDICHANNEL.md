                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">data.MIDICHANNEL</span> MIDI channel numbers.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.channelized">att.channelized</a> (@midi.channel), 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/chan">chan</a>/@num
                              </div>
                           </td>
                        </tr>
                        <tr>
