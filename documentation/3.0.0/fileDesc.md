                  ...
                  <div class="elementSpec">
                     ...
                     <table class="wovenodd">
                                 ...
                                 <div class="indent1">
                                    ...
                                    <div class="indent2">
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;rng:ref 
                                             <span class="attribute">name=</span>
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/editionStmt">editionStmt</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;rng:ref 
                                          <span class="attribute">name=</span>
                                          <span class="attributevalue">"
                                             <a class="link_odd" href="/documentation/3.0.0/pubStmt">pubStmt</a>"
                                          </span>/&gt;
                                       </span>
                                    </div>
                                    ...
                                    <div class="indent2">
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;rng:ref 
                                             <span class="attribute">name=</span>
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/sourceDesc">sourceDesc</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <p>Extent in this context represents file size.This element is modelled on elements in
                                 the Text Encoding Initiative (TEI) and Encoded
