                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/model.editLike">model.editLike</a>)
                                    </span>
                                 </div>
                                 <div>
                                 ...
                                 <div>
                                    ...
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/unclear">unclear</a>
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/model.textphraseLike">model.textphraseLike</a>)
                                    </span>
                                 </div>
                                 <div>
