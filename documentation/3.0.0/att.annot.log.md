                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.annot.log</span> Logical domain attributes for annot. Values for the type attribute can be taken from
                              any
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/annot">annot</a> (direct member of att.annot.log)
                                 </div>
                              </div>
                           </td>
                        </tr>
