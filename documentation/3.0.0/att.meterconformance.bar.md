                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.barLine.log">att.barLine.log</a>)
                                    </span>
                                 </div>
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/measure">measure</a>
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.measure.log">att.measure.log</a>)
                                    </span>
                                 </div>
                              </div>
                           </td>
