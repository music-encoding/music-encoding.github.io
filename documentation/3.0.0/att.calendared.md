            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div class="classSpec att">
                     <h3 id="att.calendared">att.calendared</h3>
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.calendared</span> Attributes that indicate the calendar system of a date or other datable element.
                           </td>
                        </tr>
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    ...
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/event">event</a> (direct members of att.calendared)
                                 </div>
                              </div>
                           </td>
                        </tr>
                              ...
                              <div xml:space="preserve" class="pre">
                                 <div class="indent1">
                                    <span data-indentation="1" class="element">&lt;attDef 
                                       ...
                                       <span class="attributevalue">"calendar"</span> 
                                       <span class="attribute">usage=</span>
                                       <span class="attributevalue">"opt"</span>&gt;
                                    </span>
                                    
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;desc&gt;</span>Indicates the calendar system to which a date belongs, for example, Gregorian,
                                       Julian, Roman, Mosaic, Revolutionary, Islamic, etc.
