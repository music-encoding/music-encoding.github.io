                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    ...
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/mapping">mapping</a> (direct members of att.responsibility)
                                 </div>
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.crit">att.crit</a>)
                                    </span>
                                 </div>
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.edit">att.edit</a>)
                                    </span>
                                 </div>
                              </div>
                           </td>
                           ...
                           <td class="wovenodd-col2">
                              <div xml:space="preserve" class="pre">
                                 <div class="indent1">
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;desc&gt;</span>Indicates the agent(s) responsible for some aspect of the text's creation,
                                       transcription, editing, or encoding. Its value must point to one or more identifiers
                                       declared in the document header.
