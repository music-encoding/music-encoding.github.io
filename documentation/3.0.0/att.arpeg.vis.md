                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.arpeg.vis</span> Visual domain attributes.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/arpeg">arpeg</a> (direct member of att.arpeg.vis)
                                 </div>
                              </div>
                           </td>
                        </tr>
                           ...
                           <td class="wovenodd-col2">
                              ...
                              <div xml:space="preserve" class="pre">
                                 <div class="indent1">
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;desc&gt;</span>Indicates if an arrowhead is to be drawn as part of the arpeggiation symbol.
