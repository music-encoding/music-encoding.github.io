            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div class="classSpec model">
                     <h3 id="model.repositoryLike">model.repositoryLike</h3>
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">model.repositoryLike</span> Groups elements that denote a corporate entity that holds a bibliographic item.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_classSpec" href="/documentation/3.0.0/model.nameLike.place">model.nameLike.place</a>
                                 </div>
                                 <div>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/repository">repository</a> (direct member of model.repositoryLike)
                                 </div>
                              </div>
                           </td>
                        </tr>
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;memberOf 
                                          ...
                                          <span class="attributevalue">"
                                             <a class="link_odd" href="/documentation/3.0.0/model.nameLike.place">model.nameLike.place</a>"
                                          </span>/&gt;
                                       </span>
                                    </div>
