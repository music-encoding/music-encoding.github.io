            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div class="classSpec att">
                     <h3 id="att.visualoffset.vo">att.visualoffset.vo</h3>
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.visualoffset.vo</span> Vertical offset attributes.
                           </td>
                        </tr>
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 ...
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.visualoffset">att.visualoffset</a>)
                                    </span>
                                 </div>
                                 <div>
                              ...
                              <div xml:space="preserve" class="pre">
                                 <div class="indent1">
                                    <span data-indentation="1" class="element">&lt;attDef 
                                       ...
                                       <span class="attributevalue">"vo"</span> 
                                       <span class="attribute">usage=</span>
                                       <span class="attributevalue">"opt"</span>&gt;
                                    </span>
                                    
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;desc&gt;</span>Records the vertical adjustment of a feature's programmatically-determined location
                                       in terms of staff interline distance; that is, in units of 1/2 the distance between
                                       adjacent staff lines.
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;rng:ref 
                                             ...
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/data.MEASUREMENTREL">data.MEASUREMENTREL</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
