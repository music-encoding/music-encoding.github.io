                     ...
                     <table class="wovenodd">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/scoreDef">scoreDef</a> (direct member of att.scoreDef.ges)
                                 </div>
                              </div>
                           </td>
                        </tr>
                                    ...
                                    <div class="indent2">
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;rng:ref 
                                             ...
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/data.PITCHNAME">data.PITCHNAME</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
                                    ...
                                    <div class="indent2">
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;rng:ref 
                                             <span class="attribute">name=</span>
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/data.TEMPERAMENT">data.TEMPERAMENT</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
