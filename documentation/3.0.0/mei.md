                  ...
                  <div class="elementSpec">
                     ...
                     <table class="wovenodd">
                                 ...
                                 <div class="indent1">
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;rng:ref 
                                          <span class="attribute">name=</span>
                                          <span class="attributevalue">"
                                             <a class="link_odd" href="/documentation/3.0.0/music">music</a>"
                                          </span>/&gt;
                                       </span>
                                    </div>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <p>The 
                                 <a class="link_odd_elementSpec" href="/documentation/3.0.0/mei">mei</a> element defines an instance of a document encoded with the
                              ...
                              <div xml:space="preserve" class="pre">
                                 <div class="indent1">
                                    <span data-indentation="1" class="element">&lt;sch:rule 
                                       ...
                                       <span class="attributevalue">"mei:*[@staff]"</span>&gt;
                                    </span>
                                    
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;sch:assert 
                                          <span class="attribute">test=</span>
                                          <span class="attributevalue">"every $i in tokenize(@staff, '\s+') satisfies $i=//mei:staffDef/@n"</span>&gt;
                                       </span>The values in @staff must correspond to @n attribute of a staffDef
                                       element.
