                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">model.respLikePart</span> Groups elements that delineate particular responsibilities as opposed to the respStmt
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    ...
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/sponsor">sponsor</a> (direct members of model.respLikePart)
                                 </div>
                              </div>
                           </td>
                        </tr>
