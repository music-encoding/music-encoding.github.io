                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">model.layerDefLike</span> Groups elements that permit declaration of layer properties.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/layerDef">layerDef</a> (direct member of model.layerDefLike)
                                 </div>
                              </div>
                           </td>
                        </tr>
