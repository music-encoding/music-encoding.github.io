                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 ...
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.layerDef.ges">att.layerDef.ges</a>)
                                    </span>
                                 </div>
                                 <div>
                                 ...
                                 <div>
                                    ...
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.staffDef.ges">att.staffDef.ges</a>)
                                    </span>
                                 </div>
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/staffGrp">staffGrp</a>
                                    <span> (via 
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.staffGrp.ges">att.staffGrp.ges</a>)
                                    </span>
                                 </div>
                              </div>
                           </td>
