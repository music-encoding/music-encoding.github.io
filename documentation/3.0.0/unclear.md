                  ...
                  <div class="elementSpec">
                     ...
                     <table class="wovenodd">
                           ...
                           <td class="wovenodd-col2">
                              <div class="attributeDef">
                                 ...
                                 <span class="attributeClasses">
                                    <a class="link_odd" href="/documentation/3.0.0/att.agentident">att.agentident</a>
                                 </span>
                              </div>
                              <div class="attributeDef">
                              ...
                              <div class="attributeDef">
                                 ...
                                 <span class="attributeClasses">
                                    <a class="link_odd" href="/documentation/3.0.0/att.reasonident">att.reasonident</a>
                                 </span>
                              </div>
                              <div class="attributeDef">
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/model.choicePart">model.choicePart</a> 
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/model.transcriptionLike">model.transcriptionLike</a>
                              </div>
                           </td>
                        </tr>
                        <tr>
                                 ...
                                 <div class="indent1">
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;memberOf 
                                          <span class="attribute">key=</span>
                                          <span class="attributevalue">"
                                             <a class="link_odd" href="/documentation/3.0.0/model.choicePart">model.choicePart</a>"
                                          </span>/&gt;
                                       </span>
                                    </div>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <p>Where the difficulty in transcription arises from an identifiable cause, the
                                 ...
                                 within the 
                                 <a class="link_odd_elementSpec" href="/documentation/3.0.0/unclear">unclear</a> element. Where the difficulty in transcription
                                 arises from action (partial deletion, etc.) assignable to an identifiable hand, the
                                 
                                 <span class="att">hand</span> attribute signifies the hand responsible for the action. The
                                 
                                 <span class="att">reason</span> attribute indicates why the material is difficult to transcribe. The
                                 
                                 <span class="att">resp</span> attribute indicates the individual responsible for the transcription of
                                 the word, phrase, or passage contained with the 
                                 <a class="link_odd_elementSpec" href="/documentation/3.0.0/unclear">unclear</a> element. The
                                 value of 
                                 <span class="att">resp</span> must point to one or more identifiers declared in the document
                                 header.This element is modelled on an element in the Text Encoding Initiative (TEI)
                                 standard.
                              </p>
                           </td>
                        </tr>
