                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <span>
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.layerDef.log.cmn">att.layerDef.log.cmn</a> (no elements directly inheriting from this class)
                                    </span>
                                 </div>
                                 <div>
                                 ...
                                 <div>
                                    <span>
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.scoreDef.log.cmn">att.scoreDef.log.cmn</a> (no elements directly inheriting from this class)
                                    </span>
                                 </div>
                                 <div>
                                 ...
                                 <div>
                                    <span>
                                       <a class="link_odd_classSpec" href="/documentation/3.0.0/att.staffDef.log.cmn">att.staffDef.log.cmn</a> (no elements directly inheriting from this class)
                                    </span>
                                 </div>
                                 <div>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <p>The 
                                 ...
                                 <a class="link_odd_elementSpec" href="/documentation/3.0.0/beam">beam</a> elements. If neither 
                                 <a class="link_odd_elementSpec" href="/documentation/3.0.0/beam">beam</a> elements or the
