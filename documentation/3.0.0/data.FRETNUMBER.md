                     ...
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">data.FRETNUMBER</span> In string tablature, the fret number. The value '0' (zero) indicates the open
                              string.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <a class="link_odd_classSpec" href="/documentation/3.0.0/att.note.ges.tablature">att.note.ges.tablature</a> (@tab.fret)
                              </div>
                           </td>
                        </tr>
                        <tr>
