            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div class="classSpec att">
                     <h3 id="att.measure.ges">att.measure.ges</h3>
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.measure.ges</span> Gestural domain attributes. The tstamp.ges and tstamp.real attributes encode the
                              onset
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/measure">measure</a> (direct member of att.measure.ges)
                                 </div>
                              </div>
                           </td>
                        </tr>
