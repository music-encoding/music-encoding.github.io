                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    ...
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/recording">recording</a> (direct members of att.mediabounds)
                                 </div>
                              </div>
                           </td>
                        </tr>
                                       ...
                                       <div class="indent3">
                                          <span data-indentation="3" class="element">&lt;rng:ref 
                                             ...
                                             <span class="attributevalue">"
                                                <a class="link_odd" href="/documentation/3.0.0/data.BETYPE">data.BETYPE</a>"
                                             </span>/&gt;
                                          </span>
                                       </div>
