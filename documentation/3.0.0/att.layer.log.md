            ...
            <div class="panel widget widget_text panel-first-child panel-last-child">
               <div class="textwidget">
                  <div class="classSpec att">
                     <h3 id="att.layer.log">att.layer.log</h3>
                     <table class="wovenodd">
                        <tr>
                           <td colspan="2" class="wovenodd-col2">
                              <span class="label">att.layer.log</span> Logical domain attributes.
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div class="parent">
                                 <div>
                                    <a class="link_odd_elementSpec" href="/documentation/3.0.0/layer">layer</a> (direct member of att.layer.log)
                                 </div>
                              </div>
                           </td>
                        </tr>
                           ...
                           <td class="wovenodd-col2">
                              ...
                              <div xml:space="preserve" class="pre">
                                 <div class="indent1">
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;desc&gt;</span>Provides a mechanism for linking the layer to a layerDef element.
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;constraintSpec 
                                          <span class="attribute">ident=</span>
                                          <span class="attributevalue">"check_defTarget_layer"</span> 
                                       ...
                                       <div class="indent3">
                                          ...
                                          <div class="indent4">
                                             <span data-indentation="4" class="element">&lt;sch:rule 
                                                ...
                                                <span class="attributevalue">"mei:layer/@def"</span>&gt;
                                             </span>
                                             ...
                                             <div class="indent5">
                                                <span data-indentation="5" class="element">&lt;sch:assert 
                                                   ...
                                                   <span class="attributevalue">"warning"</span> 
                                                   <span class="attribute">test=</span>
                                                   <span class="attributevalue">"every $i in tokenize(., '\s+') satisfies substring($i,2)=//mei:layerDef/@xml:id"</span>&gt;
                                                </span>The value in @def should correspond to the @xml:id attribute of a layerDef
                                                element.
                                                <span data-indentation="5" class="element">&lt;/sch:assert&gt;</span>
                                             </div>
                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              <div>
                                 ...
                                 <div>The value in @def should correspond to the @xml:id attribute of a layerDef element.</div>
                              </div>
                              <div xml:space="preserve" class="pre">
                                 <div class="indent1">
