                        ...
                        <tr>
                           ...
                           <td class="wovenodd-col2">
                              ...
                              <div class="attributeDef">
                                 ...
                                 <span class="attributeClasses">
                                    <a class="link_odd" href="/documentation/3.0.0/att.custos.log">att.custos.log</a>
                                 </span>
                              </div>
                              <div class="attributeDef">
                                 ...
                                 <div class="indent1">
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;memberOf 
                                          <span class="attribute">key=</span>
                                          <span class="attributevalue">"
                                             <a class="link_odd" href="/documentation/3.0.0/att.custos.vis">att.custos.vis</a>"
                                          </span>/&gt;
                                       </span>
                                    </div>
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;memberOf 
                                          <span class="attribute">key=</span>
                                          <span class="attributevalue">"
                                             <a class="link_odd" href="/documentation/3.0.0/att.custos.ges">att.custos.ges</a>"
                                          </span>/&gt;
                                       </span>
                                    </div>
                                    ...
                                    <div class="indent2">
                                       <span data-indentation="2" class="element">&lt;memberOf 
                                          <span class="attribute">key=</span>
                                          <span class="attributevalue">"
                                             <a class="link_odd" href="/documentation/3.0.0/att.custos.anl">att.custos.anl</a>"
                                          </span>/&gt;
                                       </span>
                                    </div>
